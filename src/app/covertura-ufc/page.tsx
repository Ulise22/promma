    ...
    return(
        <main className={styles.covertura__container}>
            ...
            <section className={styles.covertura__articles__container}>
                ...
                <ArticlePreview img={ufc299} url='/covertura-ufc/ufc299' title='UFC 299: ¡Sean Omalley vence a Chito y Sigue Siendo Campeón!¡Dustin Poirier Gana por Nocaut en el Segundo Asalto!' author={null} text='Además, Michael Venom Page logra una victoria en su debut en la UFC y Jack Della Maddalena logra una victoria por nocaut ante Gilbert Burns que lo hace escalar en los rankings.' date='10/03/2024' />
            ...
            <section className={styles.covertura__articles__container}>
                <ArticlePreview img={yanVSfigueiredo} url='/covertura-ufc/fight-night-yan-figueiredo' title='UFC CHINA: ¡Petr Yan vs Deiveson Figueiredo! ¡Yan Xiaonan vs Tabatha Ricci!' author={null} text='Carlos Ulberg derrota a Vokan Oezdemir por decisión en una excelente actuación por su parte. Gabriella Fernandes da la sorpresa y Somete a Wang Cong. Muslim Salikhov noquea a Song Kenan en el primer asalto.' date='23/11/2024' />
