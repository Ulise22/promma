...
import postpelea from '@/assets/peleadores__images/argentinos/ailin-perez/post-pelea.jpg'
import postpelea2 from '@/assets/peleadores__images/argentinos/ailin-perez/post-pelea2.jpg'
import pelea from '@/assets/peleadores__images/argentinos/ailin-perez/ailin-pelea.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ailín Pérez tiene un record de 9-2. Siendo 4 de sus victorias por nocaut, 1 por sumisión y 4 por decisión. Mientras que de sus 2 derrotas, 1 fue por sumisión contra la peleadora suiza <b>Stephanie Egger</b>, y la otra por descalificasión en una pelea por el campeonato <b>Samurai Fight House</b> contra la brasileña Tamires Vidal</p>
