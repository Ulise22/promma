        ...
        <main>
            ...
            <section className={styles.promotoras__container}>
                <article className={styles.promotoras__article}>
                    ...
                    <p>Luego de esto, vino una pelea de boxeo en la modalidad <b>Bare Knuckle</b>, sin guantes, entre Edye y el argentino <Link href='/argentinos/franco-tenaglia'>Franco Tenaglia</Link>, que se extendió a los 5 asaltos, terminando en una victoria por decisión para Edye.</p>
                    <p>El siguiente combate estaba titulado <b>David vs Goliat</b>, dado que fue entre el brasileño Rayminson que medía 1,67 y pesaba 61 kilos, contra Roger, un hombre que medía más de 2 metros y pesaba 120 kilos. Este combate terminó ganándolo &quot;David&quot; que con una llave al brazo derecho del adversario fue capaz de someterlo. </p>
