        ...
        <main>
            ...
            <section className={styles.promotoras__container}>
                ...
                <article className={styles.promotoras__article}>
                    ...
                    <p>PFL se ha converitido en una de las empresas de MMA que más crece en el mundo, sumando reconocimiento y estrellas a su cartelera, como es el caso de la reciente incorporación estelar de <Link href='/peleadores/francis-ngannou'>Francis Ngannou</Link>, o la llegada del argentino campeón de <b>ARES</b> <Link href='/peleadores/laureano-staropoli'>Pepi Staropeoli</Link>. Sin mencionar que ya contaban con presencias como la del Argentino que supo ser campeón en 2018 de esta compañía, como <Link href='/peleadores/emiliano-sordi'>Emiliano Sordi</Link>.</p>
                </article>
                <article className={styles.promotoras__article}>
