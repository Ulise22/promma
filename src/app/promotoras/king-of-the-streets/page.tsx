        ...
        <main>
            ...
            <section className={styles.promotoras__container}>
                <article className={styles.promotoras__article}>
                    ...
                    <p>En sintesis, no por nada se ganaron el apodo del &quot;El club de la lucha&quot;, combates violentos, donde abunda la sangre, sin reglas, sin protección alguna para los peleadores, y todo hecho de manera clandestina rememoran a aquella película de David Fincher.</p>
                </article>
            </section>
        </main>
    )
