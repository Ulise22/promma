        ...
        <main>
            ...
            <section className={styles.leyenda__articles__container}>
                <article className={styles.leyenda__article}>
                    ...
                    <p className={styles.leyenda__article__text}>Daniel Cormier, también conocido como DC, es un peleador de MMA estadounidense que supo ser campeón de Peso Pesado en 4 compañías, lograndolo tanto en <b>XMMA</b>, <b>KOTC</b>, <b>Strikeforce</b> y en <Link href='/articulos/ufc'>UFC</Link>, donde además fue campeón en la división de Peso Semipesado, logrando entrar en el selecto grupo de doble campeones simultaneos de la UFC.</p>
                    ...
                    <p className={styles.leyenda__article__text}>Daniel Cormier posee un récord en las MMA de 22-3-(1). Siendo 8 de sus 22 victorias por nocaut, 7 por sumisión y 7 por decisión. Mientras que de sus derrotas, 1 fue por nocaut y 2 por decisión. Además, tiene una pelea sin resultado, que originalmente había perdido por KO contra <Link href='/peleadores/jon-jones'>Jon Jones</Link>, pero que luego de Jones diera positivo en un testeo por esteroides, lo que resultó en un cambio en el resultado de la pelea y le permitió a DC conservar su título que había perdido en dicho combate.</p>
                    ...
                    <p className={styles.leyenda__article__text}>Luego de esto, tendría varios combates más, entre los que destacan el que tuvo contra <Link href='/leyendas/anderson-silva'>Anderson Silva</Link> en el UFC 200, aunque fue sin un título en juego. Además de las varias defensas del título que tuvo, donde también destaca la que tuvo contra <Link href='/peleadores/jon-jones'>Jon Jones</Link>, quien lo volvería a vencer, esta vez por KO. Sin embargo, Jones daría positivo por esteroides luego del combate, lo que ayudaría a Cormier a retener el título.</p>
