        ...
        <main>
            ...
            <section className={styles.leyenda__articles__container}>
                <article className={styles.leyenda__article}>
                    ...
                    <iframe className={styles.leyenda__article__video} width="560" height="315" src="https://www.youtube.com/embed/2QbOLVH_5E8?si=RH1ZCL7BNOSGS6k1" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.leyenda__article__video} width="560" height="315" src="https://www.youtube.com/embed/k-RRFvFi3OE?si=cMqhAeGHmOrCPrH5" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.leyenda__article__video} width="560" height="315" src="https://www.youtube.com/embed/TNxJP1CuJRo?si=yQ29vHzBg9P7H11I" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.leyenda__article__video} width="560" height="315" src="https://www.youtube.com/embed/d8DWEU6IhlQ?si=bDpoblEfmTYkQmpL" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.leyeda__article__video} width="560" height="315" src="https://www.youtube.com/embed/qwPBPiUzgag?si=ENZplBopanPsriia" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
