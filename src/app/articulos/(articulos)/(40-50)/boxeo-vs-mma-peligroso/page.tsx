...
/* Images */
import hero from '@/assets/articulos/heros/40-50/box_vs_mma_danger-hero.jpg'
import floydConor from '@/assets/articulos/previews/30-40/boxeador_vs_mma-preview.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/K2U3Ib2nKPA?si=cBw8YkxCLYYPuMpk" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <Image className={styles.article__image} src={floydConor} alt='' />
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/yF8ZecTVM_E?si=dhHnNUW8BHchmYe_&amp;start=332" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
