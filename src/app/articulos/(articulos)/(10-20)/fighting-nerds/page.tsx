...
/* Images */
import hero from '@/assets/articulos/10-20/fighting_nerds.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>Actualmente cuentan con 5 peleadores en la UFC, sumando entre todos ellos un récord en la compañía de 18-2, con 2 de ellos estando ranqueados en sus respectivas divisiones, con 4 de ellos estando invictos en la compañía, y con todos ellos dando un rendimiento sobresaliente, destacando por sus actuaciones superiores por sobre sus rivales, a quienes dejan destrozados al final de cada enfrentamiento. Es por ello que hoy en día, para cada seguidor habitual de la UFC, conoce perfectamente los nombres de luchadores como Caio Borralho o Carlos Prates. Debido a esto, queremos explicar el porqué son tan buenos estos luchadores, y qué mensaje quieren dejar.</p>
                    <iframe className={styles.article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/XvMfpmU1mIs?si=ANy7I-8JlT4KPhf0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <p>Las pretenciones y la proyección del club cambiaron radicalmente al momento en que un joven Caio Borralho se unió al gimnasio en 2014. Pablo quedó sorprendido por la habilidad de su compatriota luego de hacer sparring con él. De esta forma, Borralho comenzó su carrera profesional de MMA bajó el mando de Sucupira.</p>
                    ...
                    <p>Desde entonces consiguieron que tanto Carlos Prates, Jean Silva, Mauricio Ruffy, Kaynan Kruschewsky y Bruna Brasil, firmaran con la compañía. Además de lograr que peleadores que ya estaban en la UFC, comenzaran a entrenar con ellos, como es el caso de Thiago Moisés.  </p>
                    ...
                    <iframe className={styles.article__viceo} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/DNcY7ZSu0JI?si=4zrOM1_w8kSCx706" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
