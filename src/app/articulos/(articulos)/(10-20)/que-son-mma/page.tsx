        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>En la actualidad, las Artes Marciales Mixtas han experimentado un crecimiento explosivo, convirtiéndose en uno de los deportes de contacto más populares y emocionantes del mundo. Grandes organizaciones como <Link href='/articulos/ufc'>Ultimate Fighting Championship</Link> (UFC), <Link href='/articulos/one-championship'>ONE Championship</Link>, <b>BELLATOR</b>, <b>PFL</b> o la ya extinta, <b>PRIDE Fighting Championships</b> han desempeñado un papel fundamental en la popularización y comercialización de las MMA a nivel mundial.</p>
