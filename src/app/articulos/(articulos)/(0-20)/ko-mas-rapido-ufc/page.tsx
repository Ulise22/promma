...
/* Images */
import hero from '@/assets/articulos/heros/10-20/masvidal-vs-askren_hero.jpeg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>¿Pero cuál es la historia detrás de este KO? Ben Askren, hasta su pelea con Jorge Masvidal, tenía un récord invicto de 19-0, con sólo una pelea sin resultado. No sólo eso, sino que a lo largo de su carrera supo ser campeón de los títulos de Peso Wélter en <Link href='/promotoras/bellator'>Bellator</Link> y <Link href='/promotoras/one-championship'>ONE</Link>, defendiendo sus títulos en varias oportunidades.</p>
