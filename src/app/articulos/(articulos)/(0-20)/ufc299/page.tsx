...
export default function UFC299 () {
    return(
        <main>
            <ArticleHero title='UFC 299: ¡Sean O&apos;malley Vence Chito Vera Por Decisión y Sigue Siendo Campeón!¡Dustin Poirier Gana por Nocaut en el Segundo Asalto!' subtitle='' image={hero} />
