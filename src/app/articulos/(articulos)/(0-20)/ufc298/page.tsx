...
/* Images */
import hero from '@/assets/articulos/heros/ufc298_hero.webp'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>Luego de una previa en la que <Link href='/peleadores/ilia-topuria'>Ilia Topuria</Link> había asegurado que finalizaría al ya ex-campeón <Link href='/campeones/alexander-volkanovski'>Alexander Volkanovski</Link>, muchos de los espectadores más neutrales o con menos fanatismo por el español, dudaban de la capacidad del peleador para respaldar todas sus palabras con acciones en el octagono, sin embargo, Ilia calló bocas y despejó todas las dudas al momento de poner un pie en el octagono.</p>
