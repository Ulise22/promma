...
/* Images */
import hero from '@/assets/articulos/heros/goats-fem-ufc_hero.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>Cris Cyborg</h2>
                    <p>Otra peleadora activa que podría entrar en la discusión de la mejor peleadora de la historia de las MMA, y de la UFC en este caso, es Cris Cyborg, que llegó a ser campeona en hasta 4 compañías diferentes, siendo estas: <b>Strikeforce</b>, <b>Invicta</b>, <Link href='/promotoras/ufc'>UFC</Link> y <Link href='/promotoras/bellator'>BELLATOR</Link>.</p>
