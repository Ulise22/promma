...
export const metadata: Metadata = {
    ...
    description: 'La historia de como el polaco Mariuz Pudzianowski pasó de ser el 5 veces hombre más fuerte del mundo, a ser un luchador de MMA aterrador que noquea a sus rivales.',
    openGraph: {
        title: 'Luchador de MMA 5 Veces El Hombre Más Fuerte del Mundo',
        description: 'La historia de como el polaco Mariuz Pudzianowski pasó de ser el 5 veces hombre más fuerte del mundo, a ser un luchador de MMA aterrador que noquea a sus rivales.',
