        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <YouTubeEmbed videoid='WfiN1UdMgp8' />
                    ...
                    <YouTubeEmbed videoid='rgBd8JThjmQ' />
                    ...
                    <YouTubeEmbed videoid='0DbiljqKFNU' />
                    ...
                    <YouTubeEmbed videoid='Fl0Oa8LyYAw' />
                    ...
                    <YouTubeEmbed videoid='6ugN3fZQjyU' />
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
