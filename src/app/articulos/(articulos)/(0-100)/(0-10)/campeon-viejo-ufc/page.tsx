...
export const metadata: Metadata = {
    ...
    description: 'Una de las historias más inspiradoras de las MMA, sobre cómo Glover Texeira se convirtió en campeón de la UFC a sus 42 años.',
    openGraph: {
        title: 'Campeón Más Viejo de la UFC',
        description: 'Una de las historias más inspiradoras de las MMA, sobre cómo Glover Texeira se convirtió en campeón de la UFC a sus 42 años.',
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <YouTubeEmbed videoid='Qo5QOjRl8Z4' />
