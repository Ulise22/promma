...
export const metadata: Metadata = {
    ...
    description: 'El como Jorge Masvidal fue capaz de conectar el KO más rápido en la historia de la UFC.',
    openGraph: {
        title: 'Ko Más Rápido de la UFC',
        description: 'El como Jorge Masvidal fue capaz de conectar el KO más rápido en la historia de la UFC.',
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <YouTubeEmbed videoid='cUXVXvRUllQ' />
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
