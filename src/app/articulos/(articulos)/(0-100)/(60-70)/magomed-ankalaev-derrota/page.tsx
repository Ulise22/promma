...
export default function MagomedAnkalaevDerrota () {
    return(
        <main>
            <ArticleHero title='La Única Derrota de Magomed Ankalaev' subtitle='¿Contra quien perdió Ankalaev? La historia de la única derrota de Magomed Ankalaev contra Paul Craig.' image={hero} date='2025-02-14' author={null} updatedDate={null} />
