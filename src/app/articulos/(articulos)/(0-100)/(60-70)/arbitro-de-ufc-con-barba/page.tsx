        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <iframe className={`${styles.article__video} lazyload`} width="560" height="315" src="https://www.youtube.com/embed/SPFx5HscmH8?si=PF4d-BG-dJglCKVh" title="YouTube video player" frameBorder="0" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
