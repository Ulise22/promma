        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <YouTubeEmbed videoid='y6CLa0u7i_U' />
                    ...
                    <YouTubeEmbed videoid='g1jnCzo84G0' />
                    ...
                    <YouTubeEmbed videoid='0UTuXmrrEYA' />
                    ...
                    <YouTubeEmbed videoid='I1ZYRqIuOXA' />
                    ...
                    <YouTubeEmbed videoid='dud5bWvVkhg' />
