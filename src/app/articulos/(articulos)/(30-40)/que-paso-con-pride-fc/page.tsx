        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    <h2>Pride FC</h2>
                    <p>Cuando pensamos en promotoras de MMA, la primera que nos suele venir a la mente es <Link href='/articulos/ufc'>UFC</Link> por la popularidad que ha alcanza en la última década, pero lo cierto es que a principios de los 2000, esta compañía estaba sufriendo mucho y quien ocupaba el puesto como la mayor promotora de artes marciales mixtas del mundo era <b>PRIDE FC</b>, que con sus eventos organizados en Japón era un espectáculo y una sensación en el mundo oriental, contando con millones de espectadores, especialmente en Japón. Contando con grandísimas estrellas del deporte como <b>Dan Henderson</b>, <Link href='/leyendas/fedor-emelianenko'>Fedor Emelianenko</Link>, <Link href='/leyendas/anderson-silva'>Anderson Silva</Link> o <Link href='/leyendas/royce-gracie'>Royce Gracie</Link>.</p>
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/3-TZGaJi_5E?si=8kLOKQjICHr7zB8w" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <p>La compañía había comenzado a crecer mucho de la mano de <b>Naoto Morishita</b>, quien era el organizador de PRIDE. Sin embargo este hombre resultaba un problema para los Yakuza, la mafia japonesa, primero por la cantidad de deudas que había acumulado su empresa con esta organización, sino además porque Morishita resultaba ser un tipo bastante correto.</p>
                    <p>El 9 de enero de 2003 en el lujoso hotel Hilton de Tokyo, Naoto Morishita fue encontrado muerto, en lo que los policías concluyeron que fue un suicidio. Sin embargo, se sabe que cuando organizaciones como los Yakuza organizan este tipo de crímenes, la policía intenta no investigar demasiado.</p>
                    <h2>Pride FC y los Yakuza</h2>
                    <p>Básicamente PRIDE FC y Los Yakuza mantenían una relación tan cercana, porque desde sus incios el fundador de la compañía contrajó demasiadas deudas con este grupo, además los mafiosos japones también disfrutaban de las peleas y de los espectáculos que se montaban, por lo que no era raro ver a varios de sus miembros presentes en los estadios donde se organizaban estos combates, como si de espectadores VIP se tratara, y con la muerte de Naoto Morishita adquirieron más poder dentro de la organización de MMA. </p>
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/XNnlN4kgI_Y?si=zGNSi7U6GxYN9dlm" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <p>Pese a este cambio de manos en la organización, la cálidad de las peleas y de los eventos no decayó, siguiendo en su senda de creciente popularidad. Lo que si comenzó a cambiar fue el uso que se le daba a la promotora, dado que esta les servía como forma de lavar su dinero, debido a su ya mencionada popularidad que se traducía en una alta rentabilidad.</p>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/W3vbBQWs7yc?si=YekzSPrnx9nfs0n_" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
