        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>George St-Pierre supó ser un histórico campeón de la división de Peso Wélter, donde defendió el título 9 veces, siendo el que más defensas consecutivas tiene en la división, y el segundo que más tiene en la UFC. Además, en su último combate contra el inglés <b>Michael Bisping</b> en el UFC 217, se convertiría también el campeón de Peso Medio de la UFC, convirtiéndose en el septimo doble campeón de la compañía.</p>
