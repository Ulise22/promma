...
/* Images */
import hero from '@/assets/articulos/heros/mejores-estilos_hero.jpg'

export default function MejoresEstilosMMA () {
    return(
        <main>
            <ArticleHero title='Los Mejores Estilos para Pelear en MMA' subtitle='Repasaremos sólo algunos de los que son los estilos de pelea más efectivos a la hora de competir en las Artes Marciales Mixtas, usando un criterio completamente subjetivo.' image={hero} />
