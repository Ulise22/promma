...
/* Images */
import hero from '@/assets/articulos/previews/corte-peso.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>Ilia describe esta experiencia como &quot;Es como vivir en el infierno en la vida real&quot;, producto de la dureza que esto implica para el cuerpo. Además explica que es doloroso el tener a la gente cercana sufriendo por uno, haciéndolos participes de su sufrimiento. Sin embargo también reconoce que lo que viene después &quot;son momentos buenos, y no hay gloria sin dolor&quot;.</p>
                    ...
                    <p>Pese a lo díficil y sufrido que es el proceso para llegar a pesar lo que indica cada división, Ilia cuenta que el día de la pelea se llega en una forma espectacular, dado que ya le ha dado tiempo a descansar, a hacer su sesión de fisioterapia y a prepararse mentalmente para el enfrentamiento. Según sus propias palabras, cuando llega el día del combate &quot;Me siento muy peligroso.[...] Es como si te tuvieran atado 3 meses y de repente te soltaran la correa&quot;.</p>
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/32ozjKm03Aw?si=vAZGXrcVo6RFvCRY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
