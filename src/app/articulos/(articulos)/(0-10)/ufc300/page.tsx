        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>Se confirmó la pelea del número #7 de la división de Peso Pluma <b>Calvin Kattar</b>, que luego de su derrota en octubre de 2022 contra el inglés <b>Arnold Allen</b>, por TKO en el segundo asalto de la pelea, se enfrentera al ex campeón de peso gallo, que busca nuevos retos subiendo de división, luego de aquella última derrota que sufrió contra <Link href='/campeones/sean-omalley'>Sean O&apos;Malley</Link> por nocaut en el segundo asalto, que lo terminaría despojando del título.</p>
                </article>
                <AsideChamps />
            </section>
        </main>
