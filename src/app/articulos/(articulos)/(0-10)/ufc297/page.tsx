        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>En un combate que se vió muy igualado entre <Link href='/campeones/sean-strickland'>Sean Strickland</Link> y <Link href='/peleadores/dricus-du-plessis'>Dricus Du Plessis</Link>, quien luego de pelearse los 5 asaltos se terminó llevando la victoria por decisión dividida fue el sudafricano. </p>
