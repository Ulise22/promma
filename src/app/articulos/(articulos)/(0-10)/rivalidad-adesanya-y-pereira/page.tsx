...
/* Images */
import hero from '@/assets/articulos/0-10/izzy_vs_pereira.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    <p>El día de hoy vamos a hablar de una de las mayores rivalidades de la historia reciente de la <Link href='/articulos/ufc'>UFC</Link>, que guarda una historia curiosa que merece ser contada, y no es otra que la que tuvieron <Link href='/peleadores/israel-adesanya'>Israel Adesanya</Link> y <Link href='/peleadores/alex-pereira'>Alex Pereira</Link>, quienes se enfrentaron en 4 ocasiones diferentes, con 2 de estas peleas teniendo lugar en le kickboxing y las otras 2 en las MMA. </p>
                    ...
                    <iframe className={styles.article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/hcuM0kSse_g?si=pAmPEiprkLksEd2v" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/rxokyCnRe78?si=qE1k0u2DkJnWRVa2" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/tajmpQ9_b2I?si=Wa6uQn1RlFGGGHLX" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
