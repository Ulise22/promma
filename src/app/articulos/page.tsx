    ...
    return(
        <main className={styles.articulos}>
            ...
            <section className={styles.articles__container}>
                ...
                <ArticlePreview img={daveBautista} url='/articulos/dave-bautista-mma' title='El Debut en MMA de Dave Bautista' author={null} text='El día en que se dió la pelea en MMA de Dave Bautista ante Vince Lucero.' date='28/06/2024' />
