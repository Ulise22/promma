    ...
    return(
        <main className={styles.articulos}>
            ...
            <section className={styles.articles__container}>
                <ArticlePreview img={mikheilKajaia} url='/articulos/mikheil-kajaia' title='¿Quién es Mikheil Kajaia? El luchador olímpico georgiano de 97 kilos y de aspecto más aterrador que existe' author={null} text='La historia detrás del luchador grecorromano nacido en Georgia y nacionalizado serbio. ' date='22/01/2024' />
                <ArticlePreview img={joeRoganMA} url='/articulos/mejor-arte-marcial-para-pelea-callejera-joe-rogan' title='La Mejor Arte Marcial Para Una Pelea Callejera Según Joe Rogan' author={null} text='El comentarista de la UFC Joe Rogan confirma cuál es para él la mejor arte marcial para peleas callejeras. ' date='17/01/2024' />
