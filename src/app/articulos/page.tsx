...
/* 70-80 */ 
import borzSignificado from '@/assets/articulos/0-100/70-80/borz_significado.webp'
import fallarPesoUFC from '@/assets/articulos/0-100/70-80/fallar_peso_ufc.webp'
...
import hecherSosaPadre from '@/assets/articulos/0-100/80-90/hecher_sosa-padre.webp'
    ...
    return(
        <main className={styles.articulos}>
            ...
            <section className={styles.articles__container}>
                ...
                <ArticlePreview img={llegarAUFC5Pasos} url='/articulos/como-llegar-a-la-ufc' title='Descubre Como Llegar a la UFC en 5 pasos' author={null} text='Convierte tu sueño en realidad: Sigue estos 5 pasos para llegar a la UFC y ser un peleador profesional' date='24/01/2025' />
                ...
                <ArticlePreview img={allDoubleChamps} url='/articulos/todos-los-dobles-campeones-de-ufc' title='Todos los Dobles Campeones de UFC' author={null} text='¿Quiénes componen el selecto grupo de los campeones de 2 categorías de peso diferentes en la ufc?' date='01/04/2024' />
