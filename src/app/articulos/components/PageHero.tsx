...
import bestfightsFem from '@/assets/articulos/0-100/30-40/mejores_peleas_mujeres.jpg'
    ...
    return(
        <section className={styles.pagehero}>
            <Link className={styles.pagehero__bigArticle} href='/articulos/yoel-romero-genetica'>
                <Image className={styles.pagehero__bigArticle__img} priority={true} quality={50} src={yoelgenetica} alt='La genética del peleador cubano de UFC Yoel Romero' />
            ...
            <Link className={`${styles.pagehero__article} ${styles.normal1}`} href='/articulos/alexander-emelianenko'>
                <Image className={styles.pagehero__article__img} quality={50} src={alexanderEmelianenko} alt='' />
            ...
            <Link className={`${styles.pagehero__article} ${styles.normal2}`} href='/articulos/mejores-peleas-mujeres-ufc'>
                <Image className={styles.pagehero__article__img} quality={50} src={bestfightsFem} alt='' />
                <article className={styles.pagehero__article__container}>
