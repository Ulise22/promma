    ...
    return(
        <section className={styles.pagehero}>
            <Link className={styles.pagehero__bigArticle} href='/articulos/yoel-romero-genetica'>
                ...
                <p className={styles.page__title}>La Genética de Yoel Romero</p>
                <span>Yoel Romero es un superhumano, el admirable prodigio genético que ha demostrado ser el luchador cubano para seguir activo con 47 años y para sorprender a los médicos con lo rápido de su recuperación.</span>
            </Link>
            <Link className={`${styles.pagehero__article} ${styles.normal1}`} href='/articulos/alexander-emelianenko'>
                ...
                <article className={styles.pagehero__article__container}>
                    <p className={styles.pagehero__title}>Alexander Emelianenko: El Hermano de Fedor Emelianenko y su Relación con la Mafia Rusa</p>
                    <span>Los tatuajes de Alexander Emelianenko y el significado que tienen, ¿De verdad formó parte de la mafia rusa?</span>
            ...
            <Link className={`${styles.pagehero__article} ${styles.normal2}`} href='/articulos/mejores-peleas-mujeres-ufc'>
                ...
                <article className={styles.pagehero__article__container}>
                    <p className={styles.pagehero__title}>Las Mejores Peleas de UFC de Mujeres de la Historia</p>
                    <span>Los 5 mejores combates femeninos de la historia de UFC.</span>
                    <div className={styles.pagehero__article__info}>
                        <h4>FULLMMA</h4>
                        <p>29/06/2024</p>
                    </div>
