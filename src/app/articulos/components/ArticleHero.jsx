...
export default function ArticleHero ({title, subtitle, image, date, author, updatedDate}) {
    ...
    return(
        <section className={styles.articleHero}>
            ...
            <Image className={styles.articleHero__image} loading='eager' sizes='(max-width: 660px) 95vw, (max-widht: 1200px) 80vw, 33vw' priority={true} src={image} alt={title} width={800} height={450} quality={65} />
