...
export default function UFC300Prelims () {
    return(
        <main>
            <ArticleHero title='UFC 300: !Kayla Harrinson Somete a Holly Holm en el Segundo Asalto en su Debut en la UFC¡' subtitle='Por el UFC 300 Kayla somete a Holly Holm en el segundo asalto y Diego Lopes Noquea su rival en el primer asalto.' image={hero} date='13/04/2024' author={null} />
