...
export default function PoliticaPrivacidad () {
    return(
        <main className={styles.main}>
            ...
            <p>El Titular le informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios que puedan ser recabados durante la navegación a través del Sitio Web: https://chely.pe</p>
            ...
            <ul>
                ...
                <li><b>Sitio Web:</b>  https://fullmma.org/</li>
            </ul>
            ...
            <h2 className={styles.titles}>Obtención de datos personales</h2>
            <p>Para navegar por el sitio Web no es necesario que facilite ningún dato personal.</p>

            <h2 className={styles.titles}>Derechos</h2>
            ...
            <p>Para ejercitar sus derechos tiene que enviar su petición junto con una fotocopia del Documento Nacional de Identidad o equivalente a  la dirección de correo electrónico:&nbspadmin@chely.pe</p>
            ...
            <h2 className={styles.titles}>Contenido de otros sitios web</h2>
            ...
            <h2 className={styles.titles}>Política de Cookies</h2>
            ...
            <h2 className={styles.titles}>Legitimación para el tratamiento de datos</h2>
            <p>La base legal para el tratamiento de sus datos es:</p>
            <ul>
                <li>El consentimiento del interesado.</li>
            </ul>

            <h2 className={styles.titles}>Categorías de datos personales</h2>
            ...
            <h2 className={styles.titles}>Conservación de datos personales</h2>
            <p>Los datos personales proporcionados al Titular se conservarán hasta que solicite su supresión.</p>

            <h2 className={styles.titles}>Destinatarios de datos personales</h2>
            <ul>
                <li>Google Analytics es un servicio de analítica web prestado por Google, Inc., una compañía de Delaware cuya oficina principal está en 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos (&quot;Google&quot;).<br />
                ...
                Más información en: <a href='https://analytics.google.com'>https://analytics.google.com</a></li>
                <li>Google AdSense es un conjunto de servicios publicitarios proporcionado por Google, Inc., una compañía de Delaware cuya oficina principal está en 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos (&quot;Google&quot;). <br />
                AdSense utiliza las cookies para mejorar la publicidad, segmentarla según el contenido que sea relevante para los usuarios y mejorar los informes de rendimiento de las campañas. <br />
                Más información en: <a href='https://www.google.com/adsense'>https://www.google.com/adsense</a></li>
            </ul>
            <p>Puede consultar como Google gestiona la privacidad en lo que respecta al uso de las cookies y otra información en la página de Política de privacidad de Google: https://policies.google.com/privacy?hl=es</p>
            ...
            <ul>
                <li><a href='https://policies.google.com/technologies/cookies?hl=es#types-of-cookies'>Tipos de cookies que utiliza Google</a></li>
                <li><a href='https://policies.google.com/technologies/ads?hl=es'>Cómo utiliza Google las cookies en publicidad.</a></li>
            </ul>

            <h2 className={styles.titles}>Navegación Web</h2>
            ...
            <h2 className={styles.titles}>Exactitud y veracidad de los datos personales</h2>
            ...
            <h2 className={styles.titles}>Aceptación y consentimiento</h2>
            ...
            <h2 className={styles.titles}>Cambios en la Política de Privacidad</h2>
