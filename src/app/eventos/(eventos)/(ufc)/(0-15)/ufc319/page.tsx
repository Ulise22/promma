        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>Khamzat Chimaev Derrota a Dricus Du Plessis en una Actuación Súper Dominante</h2>
                    <p>Finalmente tenemos nuevo campeón, luego de que el luchador invicto <Link href='/peleadores/khamzat-chimaev'>Khamzat Chimaev</Link> hiciera lo que quiso con el campeón <Link href='/peleadores/du-plessis'>Dricus Du Plessis</Link>, quien a pesar de saber que Chimaev lo iba a buscar derribar e intantar llevar la pelea a la lucha, no pudo hacer nada contra el checheno, quien lo castigó con golpes a ras de lona, llegando a contabilizar más de 500 al finalizar el combate, y rompiendo récords de todo tipo, de golpes conectados, de intentos de derribo y de tiempo de control. </p>
                    <p>Por lo que, pese a que muchos tenías las espectativas tan altas con Chimaev que esta pelea nos deja sabor poco, lo cierto es que fue ampliamente superior, y seguramente no haya registro de una actuación tan dominante de un retador en una pelea del campeonato. Asi que luego de 25 minutos de dominio total, tenemos nuevo campeón y su nombre es <Link href='/peleadores/khamzat-chimaev'>Khamzat Chimaev</Link>. </p>
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
