...
export default function UFC328 () {
    return(
        <main>
            <ArticleHero title="UFC 328: ¡Sean Strickland Derrota a Khamzat Chimaev y es Nuevo Campeón! ¡Joshua Van Noquea a Tatsuro Taira en el Último Asalto en La Pelea de la Noche!" subtitle='¡Alexander Volkov Derrota a Waldo Cortes Acosta por Decisión Unánime! ¡Yaroslav Amosov Somete a Joel Álvarez en el Segundo Asalto!' image={hero} date='2026-05-09' author={null} updatedDate='2026-05-10' />
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>Alexander Volkov Derrota a Waldo Cortes Acosta por Decisión Unánime</h2>
                    <p>Gran victoria para el ruso <b>Alexander Volkov</b>, quien aprovechando la ventaja natural que tenía con su altura y alcance, fue capaz de usar esto a su favor para conectar golpes y mantener la distancia con <Link href='/peleadores/waldo-cortes-acosta'>Waldo Cortes Acosta</Link>, que en pocas ocasiones fue capaz de recortar esa distancia para intercambiar golpes. Además, conectando jabs, rectos y especialmente patadas a todo el cuerpo, Volkov le hizo casi imposible a Waldo acercarse, consiguiendo de esta manera puntuar su camino a la victoria. De esta forma, el ruso <b>Alexander Volkov</b> derrota a Waldo por decisión unánime. </p>
                    <h2>¡Joshua Van Noquea a Tatsuro Taira en el Último Asalto en La Pelea de la Noche!</h2>
                    <p>¡Que combate acabamos de presenciar! Sin dudas la mejor de la noche, con un <b>Tatsuro Taira</b> que sorprendió al comienzo al campeón, logrando llevarlo al suelo al comienzo del primer asalto, y logrando conectar varios derribos al birmano. Sin embargo, el luchador de Myanmar <Link href='/peleadores/joshua-van'>Joshua Van</Link>, fue capaz de sobreponerse en el segundo y tercer asalto, defendiendo mejor los derribos, y haciendo mejor uso de su boxeo con el que conectó varios golpes que estuvieron muy cerca de noquear al japonés, llevándolo al suelo. En el cuarto asalto, pese a haber estado cerca de caer KO, pudimos ver una mejora de Taira que hizo un muy buen asalto. Y finalmente, para el quinto y último round de la pelea, Joshua Van hizo una combinación de golpes entre el cuerpo y la cabeza que terminarían noqueando a su rival, llevando al árbitro a parar la pelea.</p>
                    <p>De esta manera el campeón de Myanmar <Link href='/peleadores/joshua-van'>Joshua Van</Link> completa su primer defensa exitosa del título por TKO en el quinto asalto, y espera una revancha ante el excampeón <Link href='/peleadores/alexandre-pantoja'>Alexandre Pantoja</Link>. </p>
                    <h2>¡Sean Strickland Derrota a Khamzat Chimaev por Decisión Dividida y es Nuevo Campeón!</h2>
                    <p>Impresionante lo que acabamos de ver, de nuevo, contra todas probabilidades, <Link href='/peleadores/sean-strickland'>Sean Strickland</Link> vuelve a convertirse en el campeón más inpensando de la UFC. </p>
                    <p>El primer asalto fue lo que todos esperabamos, con el campeón <Link href='/peleadores/khamzat-chimaev'>Khamzat Chimaev</Link> consiguiendo un derribo en menos de 20 segundos y controlando a su rival a ras de lona, intentando varias sumisiones. Sin embargo, Strickland demostró una gran capacidad en la lucha, resistiendo varios de los embates de su rival, y defendiendo muy bien los intentos de sumisión, sin quedar en ningún momento en una posición muy comprometida. </p>
                    <p>Para el segundo y tercer asalto pareciera que Chimaev estaba más cansado, siendo incapaz de derribar a Strickland, recibiendo varios golpes a la cara, e incluso cayendo de espaldas al suelo, con Sean golpeándolo desde arriba en una imagen que jamás pensabamos ver. El cuarto asalto tuvo Chimaev golpeando más que Strickland y consiguiendo un nuevo derribo para llevarse el asalto. Y finalmente en el quinto asalto Strickland fue capaz de resistir un intentó de llevar la pelea al suelo al comienzo del round, y consiguió golpearlo en cantidad con mucha contundencia. Quizás el quinto asalto fue el más cerrado de todos, razón por la que finalmente <Link href='/peleadores/sean-strickland'>Sean Strickland</Link> se convirtió en nuevo campeón de peso mediano de la UFC por decisión dividida, con el último asalto siendo el de la discordia para los jueces. </p>
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
