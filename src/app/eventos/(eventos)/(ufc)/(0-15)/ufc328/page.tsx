...
export default function UFC328 () {
    return(
        <main>
            <ArticleHero title="UFC 328: ¡Khamzat Chimaev vs Sean Strickland! ¡Joshua Van Noquea a Tatsuro Taira en el Último Asalto en La Pelea de la Noche!" subtitle='¡Alexander Volkov Derrota a Waldo Cortes Acosta por Decisión Unánime! ¡Yaroslav Amosov Somete a Joel Álvarez en el Segundo Asalto!' image={hero} date='2026-05-09' author={null} updatedDate={null} />
