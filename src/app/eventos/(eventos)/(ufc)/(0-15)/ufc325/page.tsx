...
export default function UFC325 () {
    return(
        <main>
            <ArticleHero title="UFC 325: ¡Alexander Volkanovski vs Diego Lopes! ¡Benoit Saint Denis Noquea a Dan Hooker en el Segundo Asalto!" subtitle='¡Mauricio Ruffy Noquea a Rafael Fiziev en el Segundo Asalto! ¡Quillan Salkilld Somete a Jamie Mullarkey en el Primer Asalto!' image={hero} date='2026-01-31' author={null} updatedDate='2026-02-01' />
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>Benoit Saint Denis Noquea a Dan Hooker en el Segundo Asalto</h2>
                    <p>En el combate más sangriento y caótico hasta el momento, quien salió victorioso es el francés <b>Benoit Saint Denis</b>, quien luego de pasar por muchos intercambios de golpes en los que no siempre salió beneficiado, pudo derribar a Hooker para castigarlo con ground & pound, conectando unos codazos que hicieron sangrar a su rival. En el segundo asalto, luego de un intento fallido pero que cerca estuvo de prosperar, de conectar un D&apos;arce Choke, prosiguió a golpear a su rival hasta que el árbitro los separó para dar como ganador a Benoit Saint Denis por TKO en el segundo asalto. </p>
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
