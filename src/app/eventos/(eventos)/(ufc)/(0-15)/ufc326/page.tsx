...
export default function UFC326 () {
    return(
        <main>
            <ArticleHero title="UFC 326: ¡Charles Oliveira Derrota a Max Holloway y es el Nuevo BMF!" subtitle='¡Caio Borralho Derrota a Reiner De Ridder por Decisión Unánime! ¡Raúl Rosas Jr. Derrota a Rob Font por Decisión Unánime y Se Mete en los Rankings!' image={hero} date='2026-03-07' author={null} updatedDate='2026-03-08' />
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>Charles Oliveira Derrota a Max Holloway y es el Nuevo BMF</h2>
                    <p>Aplastante victoria del brasileño excampeón de peso ligero <Link href='/peleadores/charles-oliveira'>Charles Oliveira</Link> que llevó la pelea al terreno que le resultaba más cómodo, derribando a <Link href='/peleadores/max-holloway'>Max Holloway</Link> siempre antes de que se cumpla el minuto en cada asalto, y manteniéndolo a ras de lona amagando a intentar sumisiones a cada rato, logrando ganar absolutamente todos los asaltos y de esta forma ganar la pelea por decisión unánime. </p>
                    <p>Lo cierto es que la pelea fue algo decepcionante y bastante menos entretenida de lo que esperabamos, pero Charles Oliveira hizo lo que tenía que hacer si quería ganar, uso sus puntos fuertes y no se dejó golpear por Max Holloway que sabemos que es un peleador peligrosísimo. De esta forma el brasileño consigue su segunda victoria al hilo y se convierte en el nuevo BMF de la UFC. </p>
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
