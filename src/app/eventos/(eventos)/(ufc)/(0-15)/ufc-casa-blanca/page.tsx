...
export default function UFCCasaBlanca () {
    return(
        <main>
            <ArticleHero title="UFC Casa Blanca: ¡Ilia Topuria vs Justin Gaethje! ¡Alex Pereira vs Ciryl Gane!" subtitle='¡Sean O&apos;Malley vs Aiemann Zahabi! ¡Josh Hokit vs Derrick Lewis!' image={hero} date='2026-06-14' author={null} updatedDate={null} />
