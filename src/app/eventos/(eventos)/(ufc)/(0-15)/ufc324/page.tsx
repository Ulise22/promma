...
export default function UFC324 () {
    return(
        <main>
            <ArticleHero title="UFC 324: ¡Paddy Pimblett vs Justin Gaethje! ¡Sean O&apos;Omalley vs Song Yadong!" subtitle='¡Waldo Cortes Acosta! ¡Arnold Allen vs Jean Silva! ¡Umar Nurmagomedov Derrota a Deiveson Figueiredo Por Decisión Unánime!' image={hero} date='2025-12-24' author={null} updatedDate={null} />
