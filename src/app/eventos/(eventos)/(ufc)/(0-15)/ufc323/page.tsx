...
export default function UFC323 () {
    return(
        <main>
            <ArticleHero title="UFC 323: ¡Merab Dvalishvili vs Petr Yan 2! ¡A Alexandre Pantoja se le Sale el Codo de Lugar y Joshua Van es el Nuevo Campeón!" subtitle='¡Tatsuro Taira Noquea a Brandon Moreno en el Segundo Asalto! ¡Payton Talbott Destruye a Henry Cejudo en su Pelea de Retiro!' image={hero} date='2025-12-06' author={null} updatedDate='2025-12-07' />
