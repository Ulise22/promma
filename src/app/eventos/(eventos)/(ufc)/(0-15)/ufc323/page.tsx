...
export default function UFC323 () {
    return(
        <main>
            <ArticleHero title="UFC 323: ¡Petr Yan Derrota a Merab Dvalishvili y es Nuevo Campeón de UFC! ¡A Alexandre Pantoja se le Sale el Codo de Lugar y Joshua Van es el Nuevo Campeón!" subtitle='¡Tatsuro Taira Noquea a Brandon Moreno en el Segundo Asalto! ¡Payton Talbott Destruye a Henry Cejudo en su Pelea de Retiro!' image={hero} date='2025-12-06' author={null} updatedDate='2025-12-07' />
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>Payton Talbott Destruye a Henry Cejudo en su Pelea de Retiro</h2>
                    <p>Exhibición total del joven estadounidense <b>Payton Talbott</b>, que hizo lo que quiso con su rival, mostrándose superior en todas las facetas del juego, en el striking (donde quizás era un poco más esperable por los estilos de cada uno), pero en la lucha también, con Payton siendo capaz de derribar a un luchador olímpico como lo es <b>Henry Cejudo</b>, quien hoy cayó derrotado y se retiró de las MMA, dejando detrás un enorme legado, habiendo sido doble campeón de la UFC y una completa leyenda del deporte. </p>
                    <h2>Tatsuro Taira Noquea a Brandon Moreno en el Segundo Asalto</h2>
                    <p>Durísima derrota para el mexicano <Link href='/peleadores/brandon-moreno'>Brandon Moreno</Link>, quien pese a haber dominado y ganado cómodo el primer asalto del combate, recibió un nocaut técnico en el segundo asalto por parte de su rival japonés <b>Tatsuro Taira</b>, quien al ganarle la espalda a su rival en el suelo, quedándo por encima de este, tuvo vía libre para golpearlo en la cabeza sin que el mexicano pueda defenderse, llevando al árbitro a parar la pelea para que Tatsuro Taira se haga con la victoria por TKO en el segundo asalto. </p>
                    <h2>¡A Alexandre Pantoja se le Sale el Codo de Lugar y Joshua Van es el Nuevo Campeón!</h2>
                    <p>Curiosa manera de convertirse en campeón la de <b>Joshua Van</b>, quien consigue el cinturón de las 125lbs en un combate que no duró ni un asalto, luego de que el campeón <Link href='/peleadores/alexandre-pantoja'>Alexandre Pantoja</Link> cayera de mala manera sobre su brazo izquierdo, dislocándose y perdiendo la pelea por TKO al no poder continuar peleando con esta lesión. De esta manera, aunque no es de la manera que queríamos, tenemos nuevo campeón de peso mosca con Joshua Van, que con solo 24 años ya es rey de las 125lbs. </p>
                    <h2>¡Petr Yan Derrota a Merab Dvalishvili y es Nuevo Campeón de UFC!</h2>
                    <p>Contra todo pronóstico, el excampeón ruso <Link href='/peleadores/petr-yan'>Petr Yan</Link> hace una pelea sobresaliente y derrota de manera contundente al campeón <Link href='/peleadores/merab-dvalishvili'>Merab Dvalishvili</Link>, quien estaba haciendo su cuarta defensa del cinturón en el año. Siendo capaz de conectar los mejores golpes, que claramente hicieron mucho daño a Merab que a mendida que los recibía iba perdiendo confianza, y más importante, siendo capaz de defender casi todos los intentos de derribos del georgiano, mostrando un nivel de élite en este aspecto, además de ser capaz él mismo de derribar a Dvalishvili en más de una ocasión, para finalmente llevarse la victoria por decisión unánime y convertirse en el nuevo campeón de peso gallo de la UFC. </p>
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
