...
export default function UFC330 () {
    return(
        <main>
            <ArticleHero title="UFC 330: ¡Islam Makhachev Derrota a Ian Garry Por Decisión Unánime y Sigue Siendo Campeón! ¡Mackenzie Dern Derrota a Gillian Robertson por Decisión Unánime y Retiene el Cinturón!" subtitle='¡Esteban Ribovics Noquea en el Segundo Asalto en el Retiro de Edson Barboza! ¡Chidi Njokuani Derrota a Joel Álvarez por Decisión Unánime!' image={hero} date='2026-08-15' author={null} updatedDate='2026-08-16' />
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>¡Islam Makhachev Derrota a Ian Garry Por Decisión Unánime y Sigue Siendo Campeón!</h2>
                    <p>Muy buena pelea estelar la que nos regalaron los protagonistas de esta noche, <Link href="/peleadores/islam-makhachev">Islam Makhachev</Link> e <Link href="/peleadores/ian-garry">Ian Garry</Link>, con el campeón revalidando su título y demostrando porque es el mejor peleador de toda la UFC en la actualidad, dominando claramente, siendo capaz de derribar y llevar al suelo a su rival europeo en todos los asaltos, y, por si fuera poco, estando cerca hasta de noquearlo en el segundo asalto, atrapándolo con una patada a la cabeza que derrribó al irlandés. </p>
                    <p>El peleador de Daguestán ganó claramente los primeros 2 asaltos, con el segundo siendo el mejor de la pelea, perdió el tercero, donde pudimos ver la mejor cara de Ian Garry, quien en ese momento defendió mejor los derribos y fue capaz de conectar varios golpes que lastimaron a su rival. El cuarto fue el más cerrado de los 5, donde en mi opinión lo ganó Makhachev, que derribó constantemente a Garry y lo mantuvo contra la reja, pero lo cierto es que ese también fue el asalto en el que más daño recibió, sufriendo un corte en la cara y teniendo que lidiar con más de 20 golpes al rostro. </p>
                    <p>Por último, el asalto que definía todo fue el quinto donde el de Rusia no dejó ningún tipo de dudas de quien es el mejor, especialmente en los últimos 3 minutos, cuando fue capaz de derribar y controlar en el suelo al de Irlanda, tomándole la espalda y amenazando con una sumisión constamente, castigándolo a golpes durante todo el final del round. </p>
                    <p>De esta forma <Link href="/peleadores/islam-makhachev">Islam Makhachev</Link> retiene el título, concreta su primera defensa exitosa, y se úne al selecto club de los doble campeones que defendieron su cinturón en 2 divisiones diferentes, junto a <Link href="/peleadores/jon-jones">Jon Jones</Link> y <Link href="/leyendas/daniel-cormier">Daniel Cormier</Link>. Además, se convierte en el peleador con la racha de victorias consecutivas más larga en la historia de la UFC, con 17, superando las 16 que supo tener en su momento <Link href="/leyendas/anderson-silva">Anderson Silva</Link>. </p>
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
