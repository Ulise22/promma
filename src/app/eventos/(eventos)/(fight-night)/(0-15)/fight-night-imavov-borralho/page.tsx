        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <h2>Mason Jones Noquea a Bolaji Oki en el Segundo Asalto</h2>
                    <p>El luchador de peso ligero de Gales <b>Mason Jones</b> se hace con la victoria de manera sorprendente, estando a punto de caer noqueado en el primer asalto, fue capaz de sobrevivir a los ataques del belga <b>Bolaji Oki</b>, y de dar vuelta completamente la pelea, aprovechando todo el desgaste que hizo su rival al intentar tumbarlo, para finalmente ser el mismo Mason Jones quien termine conectando los golpes de poder, que aturdieron a su rival y cerca estuvieron de noquearlo al final del primer asalto. En el segundo el galés fue capaz de mantener el ritmo de lucha con el que había terminado el asalto anterior, derribando a su rival, y una vez montado encima de este, lo golpeó con codazos hasta que el árbitro terminó la pelea dándolo como ganador de este combate. </p>
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
