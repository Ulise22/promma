...
import sparring from '@/assets/peleadores__images/alex-pereira/pereira_sparring.jpg'
import sparring2 from '@/assets/peleadores__images/alex-pereira/pereira_sparring2.jpg'
import alexPereira from '@/assets/peleadores__images/alex-pereira/pereira.jpg'
import alex from '@/assets/peleadores__images/alex-pereira/pereira_card.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Alex Pereira es el actual campeón de Peso Semipesado de MMA y es el número #5 libra por libra de la <Link href='/promotoras/ufc'>UFC</Link>, luego de que recientemente derrotará por nocaut a su rival <b>JIŘÍ PROCHÁZKA</b> en el segundo asalto, ganando así el título que había quedado vacante en la división.</p>
                    <p className={styles.peleador__article__text}>Debutó en la compañía el 6 de noviembre de 2021 contra el griego Andreas Michailidis por UFC 268, a quien derrotó por TKO a los 18 segundos del segundo asalto, lo que ya en su primer combate le valió para ser la Actuación de la Noche. Desde entonces fue capaz de ser campeón de Peso Medio, al derrotar a <b>Israel Adensanya</b> por TKoO en el 5to asalto, título que terminaría perdiendo en su revancha contra el mismo peleador, quien lo terminaría dejando KO en el segundo asalto.</p>
                    ...
                    <p className={styles.peleador__article__text}>Después de su derrota contra &quot;Izzy&quot;, Pereira decidiría subir de división para comenzar a competir en los Semipesados de la UFC. Allí, le bastaron tan sólo 2 combates para convertirse en campeón. Luego de que venciera por decisión dividida al polaco Jan Blachowicz, y luego de que fuera capaz de noquear al checo <b>Jiří Procházka</b> en el segundo asalto por UFC 295 el 11 de noviembre de 2023.</p>
                </article>
                <article className={styles.peleador__article}>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={sparring} alt='El peleador brasileño de MMA Alex Pereira haciendo un sparring con un compañero' />
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Su última pelea fue contra el luchador checo <b>Jiří Procházka</b> quien llevaba una racha de 13 combates consecutivos, siendo 3 de estos últimos por UFC, y quien ya habia sido campeón de la división en UFC, pero que se vió forzado a dejar vacante el título debido a una lesión en el hombro en 2022.</p>
                    <Image className={styles.peleador__article__image} src={alex} alt='Imagen de Alex Pereira después de su pesaje previo a su combate contra Israel Adensanya en UFC' />
                    <p className={styles.peleador__article__text}>La pelea se la terminó llevando el brasileño, luego de que fuera capaz de conectar unos buenos golpes y codazos en la cabeza de Jiri, lo que teminó llevando al arbitro a parar la pelea. Eso sí, dejando algo de polémica sobre que tan bien estuvo o no parada la pelea. Polémica que fue zanjada por el mismo Jiri Procházca al ser consultado sobre si estuvo bien parado el combate o no: &quot;Creo que ha estado bien. Estaba noqueado. No hubiese parado aunque estuviese noqueado, mi cuerpo sigue trabajando. Pero estas cosas pasan, no importa. Vamos a trabajar en ello y volveremos más fuertes que nunca. Gracias Alex, por esta pelea. Un gran aprendizaje. Estaré de vuelta&quot;.</p>
                </article>
            </section>
        </main>
    )
