...
import ufc4 from '@/assets/peleadores__images/0-10/tom-aspinall/aspinal_ufc4.jpg'
        ...
        <main> 
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Su último combate fue el que tuvo contra el ruso <b>Sergei Pavlovich</b> por el campeonato interino de peso pesado de la UFC, combate que tuvo lugar el 11 de noviembre de 2023 por el UFC 295, en donde Tom Aspinall se haría con la pelea y con el cinturón interino en el primer asalto por KO.</p>
                </article>
                <article className={styles.peleador__article}>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Tras una carrera amateur exitosa en el mundo amateur de las MMA, finalmente hizo su debut profesional contra el canadiense <b>Michał Piszczek</b> a quien acabó ganand opor nocaut ni bien empezar el combate en el primer asalto. En esta línea acumularía un récord de 5-2 hasta recibir su primer oferta para pelear en <Link href='/promotoras/ufc'>UFC</Link>, oferta que rechazó ya que había afirmado no sentirse preparado, en su lugar se fue a pelear a <b>Cage Warriors</b>, donde entre otros, peleó <Link href='/peleadores/conor-mcgregor'>Conor Mcgregor</Link>. En esta compañía tednría 2 combates contra los franceses <b>Sofiane Boukichou</b> y <b> Mickael Ben Hamouda</b>, en ambos casos terminaría por derrotarlos por nocaut en el primer asalto de forma muy rápida, lo que llevaría a que finalmente acepte pelear en UFC.</p>
                    <Image className={styles.peleador__article__image} src={ufc4} alt='El peleador de UFC Tom Aspinall y su personaje con sus características en el juego de EA Sports UFC4' />
