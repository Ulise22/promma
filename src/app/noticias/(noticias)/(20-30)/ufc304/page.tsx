...
export default function UFC303 () {
    return(
        <main>
            <ArticleHero title='UFC 304: ¡Leon Edwards vs Belal Muhammad! ¡Tom Aspinall Noquea a Curtis Blaydes en el Primer Asalto!' subtitle='¡Paddy Pimblett somete a Bobby Green en el primer asalto de la pelea!' image={hero} date='2024-07-27' author={null} />
