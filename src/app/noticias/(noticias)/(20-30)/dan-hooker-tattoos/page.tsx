...
/* Images */
import hero from '@/assets/noticias/heros/20-30/dan_hooker_tattoos-hero.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/GRnJNVc6mrM?si=A2iYP5hEEKgDCPhG" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <h2>Significado del Tutuaje en la Espalda de Dan Hooker</h2>
                    <p>El primero de los tatuajes que Hooker decidió hacerse en el cuerpo es el del Kabuto (el casco tradicional de la armadura japonesa) de un samurái. Este casco formaba una parte importante en el equipamiento de los samuráis, y dado la cantidad de textos y códigos reflejados en él, fue ganando un papel muy simbólico para quienes usaban el Kabuto.</p>
                    ...
                    <p>En marzo de 2023, Dan Hooker decidió también que era momento de tatuarse las piernas, en esta ocasión decidió hacerse el tatuaje tradicional de la tribu Maorí <b>Ta Moko</b>, que es una marca permanente que seh hacían los pueblos indígenas de Nueva Zelanda (país del que recordemos que es Dan Hooker). Para la tribu Maorí, este tatuaje es un recordatorio a las personas de la responsabilidad que deben llevar en sus hombros a los largo de sus vidas, es por esto que para ellos el recibir este tatuaje, es un gran momento de orgullo y honor.</p>
                    <Image className={styles.article__image} src={legsTattoos} alt='' />
                    <p>A Hooker le parecía que se veía estúpido tener tatuada sólo una de sus piernas, por lo que decidió tatuarse la otra también. Esto es algo parecidio a lo que le sucedió con sus brazos, dado que en un inicio sólo se tatuó uno, pero vió necesario tatuarse el otro también. </p>
                    <p>De esta forma pasó de no tener ningún tatuaje en su cuerpo a ir llenándose de estos en muy poco tiempo. Para quien tenga curiosidad de saber cómo le fue en su carrera deportiva desde que comenzó a tatuar su cuerpo, sólo ha tenido una pelea y fue la que tuvo lugar en el <b>UFC 290</b> ante el estadounidense <b>Jalín Turner</b>, obteniendo una victoria por decisión dividida. </p>
                </article>
                <AsideChamps />
            </section>
        </main>
