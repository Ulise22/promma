...
/* Images */
import hero from '@/assets/noticias/heros/30-40/drake_apuesta-hero.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>El caso más reciente de Drake apostando por un peleador que acabaría perdiendo, ocurrió hace un par de días, cuando en el <Link href='/noticias/ufc305'>UFC 305</Link> apostó $450,000 a favor del retador del título de peso medio <Link href='/peleadores/israel-adesanya'>Israel Adesanya</Link>, quien caería derrotado por sumisión en el cuarto asalto de la pelea ante el campeón <Link href='/peleadores/dricus-du-plessis'>Dricus Du Plessis</Link>.</p>
                    ...
                    <p>En la conferencia de prensa posterior a la pelea, el mismo Colby Covington se refirió a esta apuesta y le dijo a Drake que &quot;vuelva a vender esos albumes de mierda&quot;. </p>
