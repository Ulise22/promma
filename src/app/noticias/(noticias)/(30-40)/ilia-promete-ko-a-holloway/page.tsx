...
/* Images */
import hero from '@/assets/noticias/heros/30-40/ilia_promissko_holloway-hero.jpg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/2WkaSIV7F1w?si=OtxiV6QZOBbUYtcH" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <p>Sobre Volkanovski afirmando que esperaba ser el peleador de respaldo de la pelea, dijo: <b>&quot;No lo sé, creo que espera ser noqueado 2 veces por año. Quizás alguien deba darle un buen consejo y decirle que necesita un descanso&quot;</b>.</p>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/EQL0U5F6JKA?si=LHvgEScu5YEUw2xK" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <h2>La opinión de Ilia Topuria sobre el Diego Lopes vs Brian Ortega</h2>
                    <p>Al ser consultado sobre las peleas que se vienen en su división, Ilia afirmó que cree que en la pelea entre <Link href='/peleadores/diego-lopes'>Diego Lopes</Link> y <b>Brian Ortega</b> está el próximo contendiente al título. </p>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/CuN2kRgh8vs?si=oyZnM6uSDYQlgpnM" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
