        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <YouTubeEmbed videoid='nsODUCSOaoc' />
                    ...
                    <YouTubeEmbed videoid='rm3hR_trgC4' />
                    ...
                    <YouTubeEmbed videoid='dM1lbdLcLTU' />
                    ...
                    <YouTubeEmbed videoid='bzt-axpd67M' />
                    ...
                    <YouTubeEmbed videoid='ZcOAUBjdEOI' />
                    ...
                    <YouTubeEmbed videoid='BkUL0oMZ8z8' />
                    ...
                    <YouTubeEmbed videoid='J0ev0FNvjmc' />
                    ...
                    <YouTubeEmbed videoid='6eD8lXTb0Xs' />
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
