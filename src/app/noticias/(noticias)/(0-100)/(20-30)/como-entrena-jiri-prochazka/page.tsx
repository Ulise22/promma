        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    <p>El próximo sábado 18 de enero de este 2025, tendremos el primer evento numerado de UFC, el UFC 311, donde estará peleando el que personalmente es uno de mis luchadores favoritos, Jiri Prochazka, enfrentando al excampeón de la división de peso semipesado <b>Jamahal Hill</b>. Ambos luchadores vienen de una derrota por nocaut ante el actual campeón Alex Pereira, y estarán en busca de una victoria que les de la oportunidad de volver a pelear por el cinturón en el futuro cercano.</p>
                    ...
                    <iframe className={styles.article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/qWenqBOh5kg?si=8wZ0LhHXR-R1GnUI" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/KwMvuI_Q0AE?si=kPvnEUT1_xViM3_B" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
