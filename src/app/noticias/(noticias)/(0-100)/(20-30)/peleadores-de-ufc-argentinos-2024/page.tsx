        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <YouTubeEmbed videoid='t2pdtBmsECE' />
                    <h2>2.Ailín Pérez</h2>
                    ...
                    <YouTubeEmbed videoid='VUvS_7585WA' />
                    ...
                    <YouTubeEmbed videoid='CExoos0xrnc' />
                    ...
                    <YouTubeEmbed videoid='vNqq5kXpFJU' />
                    ...
                    <YouTubeEmbed videoid='ZIV6ahzuVv8' />
                    <EndArticle />
                </article>
                <AsideChamps />
            </section>
