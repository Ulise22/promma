...
export default function ProximaPeleaVolkanovski () {
    return(
        <main>
            <ArticleHero title='¿Quién es Michael Morales? El Luchador Ecuatoriano de 25 Años que Está Invicto en la UFC' subtitle='La historia del ecuatoriano Michael Morales que recientemente acaba de entrar en el Ranking de peso wélter en la UFC.' image={hero} date='2024-08-27' author={null} updatedDate={null} />
