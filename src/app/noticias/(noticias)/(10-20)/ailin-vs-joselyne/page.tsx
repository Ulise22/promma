        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>De esta manera, en sus 4 peleas dentro de la UFC <Link href='/mujeres/ailin-perez'>Ailín Pérez</Link>, completa un total de 3 victorias consecutivas, luego de aquel debut con derrota que sufrió contra la suiza <b>Stephanie Egger</b>, quien la sometió en el segundo asalto.</p>
