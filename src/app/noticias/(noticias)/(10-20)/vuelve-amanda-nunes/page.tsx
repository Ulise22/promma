        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>Además, el mismo Dana White en la conferencia de prensa posterior al <Link href='/noticias/ufc300-main-event'>UFC 300</Link> confesó que estaría encantado de organizar esta super pelea femenina. Además creemos, que si finalmente Kayla Harrison termina quedándose con el cinturón de la división, una defensa ante la excampeona sería bastante más emocionante que cualquiera de las otras posibilidades que hay.</p>
                </article>
                <AsideChamps />
            </section>
        </main>
