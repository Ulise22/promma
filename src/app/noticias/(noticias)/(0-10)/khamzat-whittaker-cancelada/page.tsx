        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <p>La pelea prometía bastante, dado que el mismo Dana White la había anunciado como una eliminatoria por el título, viniendo ambos peleadores de una victoria en sus respectivos combates, venciendo Whittaker al brasileño <b>Paulo Costa</b> en el <Link href='/covertura-ufc/ufc298'>UFC 298</Link>, y viniendo Chimaev de una victoria contra <Link href='/peleadores/kamaru-usman'>Kamaru Usman</Link>, luego de vencerlo por decisión mayoritaria al finalizar los 3 asaltos en el UFC 294.</p>
