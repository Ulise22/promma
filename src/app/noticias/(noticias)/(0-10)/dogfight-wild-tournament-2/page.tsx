...
/* Images */
import hero from '@/assets/noticias/heros/0-10/dogfight2.jpg'
import aitorvszdravko from '@/assets/noticias/insideArticle/dwf2/aitor-vs-zdravko.jpeg'
import twovtwo from '@/assets/noticias/insideArticle/dwf2/2v2.jpeg'
import firstSemifinal from '@/assets/noticias/insideArticle/dwf2/sergio-hidalgo.jpeg'
import secondSemifinal from '@/assets/noticias/insideArticle/dwf2/segunda_semifinal.jpeg'
import bareknuckleFem from '@/assets/noticias/insideArticle/dwf2/boxeo-femenino.jpeg'
import norules from '@/assets/noticias/insideArticle/dwf2/no-rules.jpeg'
import cesarAlonso from '@/assets/noticias/insideArticle/dwf2/cesar_alonso.jpeg'
import threeVSone from '@/assets/noticias/insideArticle/dwf2/3-v-1.jpeg'
        ...
        <main>
            ...
            <section className={styles.article__container}>
                <article className={styles.article}>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/dM1lbdLcLTU?si=sTHQLz0qNJ_Le6wv" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/bzt-axpd67M?si=t5xRlm0-tDHqnGkN" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/ZcOAUBjdEOI?si=fphkpp_iiXAoH-3X" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/BkUL0oMZ8z8?si=04wxOJj6ZCZf2kS6" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/J0ev0FNvjmc?si=TmLqVNE5Rq4Fb4EX" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.article__video} width="560" height="315" src="https://www.youtube.com/embed/6eD8lXTb0Xs?si=1398kzdc0jIkvwkD" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
