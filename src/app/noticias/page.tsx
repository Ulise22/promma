    ...
    return(
        <section className={styles.noticiaspage__container}>
            <article className={styles.noticiasHero}>
                <Link className={styles.noticiasHero__bigArticle} href='/noticias/ufc-casa-blanca'>
                    <Image className={styles.noticiasHero__bigArticle__img} priority={true} quality={50} src={ufcWhiteHouse} alt='' />
                    <h2 className={styles.page__title}>UFC Casa Blanca: Todo lo que Tienes Que Saber Sobre el UFC Freedom 250</h2>
                    <p>Todos los detalles sobre el evento de UFC organizado en la Casa Blanca por el 250 aniversario del Día de la Independencia en Estados Unidos</p>
                </Link>
                <Link className={`${styles.noticiasHero__article} ${styles.normal1}`} href='/noticias/ilia-topuria-que-paso-con-su-esposa'>
                    <Image className={styles.noticiasHero__article__img} quality={50} src={iliaWife} alt='' />
                    <article className={styles.noticiasHero__article__container}>
                        <h2 className={styles.noticiasHero__title}>Ilia Topuria Qué Pasó Con su Esposa</h2>
                        <p>Todo sobre Ilia Topuria, sobre la separación, las acusaciones y cómo superó uno de los momentos más duros de su vida</p>
            ...
            <article className={styles.noticiasHero__container}>
                <ArticlePreview img={mcgregorQuePaso} url='/noticias/que-le-paso-a-conor-mcgregor' title='¿Qué Le Pasó a Conor McGregor?' author={null} text='Descubre que le pasó en la pierna a Conor McGregor en su pelea contra Max Holloway en el UFC329' date='12/07/2026' />
            ...
            <article className={styles.noticias}>
                ...
                <ArticlePreview img={iliaPeleador2024} url='/noticias/ilia-topuria-peleador-del-2024' title='Opinión: Ilia Topuria es el Peleador del Año 2024 en UFC' author={null} text='Luego de lo realizado en el UFC 308, al Ilia Topuria noquear a Max Holloway, no quedan dudas de que Ilia Topuria es el peleador del año 2024.' date='27/10/2024' />
