...
import valentina from '@/assets/peleadores__images/valentina-shevchenko/shevchenko.png'
import shevchenko from '@/assets/peleadores__images/valentina-shevchenko/valentina-shevchenko.jpg'
import fight from '@/assets/peleadores__images/valentina-shevchenko/fight.jpg'
import postfight from '@/assets/peleadores__images/valentina-shevchenko/postfight.jpg'
import sparring from '@/assets/peleadores__images/valentina-shevchenko/sparring.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={fight} alt='La peleadora peruana de MMA lanzando un golpe en medio de su combate de UFC' />
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>La última pelea de Valentina Shevchenko fue su revancha por el título contra la mexicana <Link href='/campeones/alexa-grasso'>Alexa Grasso</Link>. Su primer enfrentamiento se había dado el 4 de marzo de 2023 por UFC 285 en Las Vegas, donde la mexicana le terminaría arrebatando el título a Valentia, luego de vencerla por sumisión en el tercer asalto del combate.</p>
                    <p className={styles.peleador__article__text}>Este último encuentro se dio también en Las Vegas en <b>UFC Fight Night: Grasso vs Shevchenko 2</b>. El combate duró los 5 asaltos y finalmente terminó en empate, lo que ayudo a Alexa a retener su título. Sin embargo, hubo polémica sobre la decisión de los jueces, al punto de que <b>Dana White</b> ya ha hablado de una posible tercera pelea entre estas 2 peleadoras. Así que habrá que esperar para ver quien será la futura poseedora del título de Peso Mosca Femenino que por ahora, sigue en manos de la mexicana Alexa Grasso.</p>
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/cqUHq7zyiQE?si=_Y1AU3J_rqPMJJet" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </article>
            </section>
        </main>
    )
