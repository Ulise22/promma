...
import pelea from '@/assets/peleadores__images/juliana-pena/julianna_pelea.jpg'
import juliPena from '@/assets/peleadores__images/juliana-pena/julianna_pena.jpg'
import peña from '@/assets/peleadores__images/juliana-pena/julianna_peña.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={juliPena} alt='La artista marcial venezolana Juliana Peña levantando los brazos en señal de victoria luego de ganar su combate de MMA' />
                </article>
                <article className={styles.peleador__article}>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={peña} alt='Juliana Peña en el pesaje previo a su pelea de UFC' />
