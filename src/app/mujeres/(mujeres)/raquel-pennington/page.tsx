...
import fight2 from '@/assets/peleadores__images/mujeres/raquel-pennington/raquel_fight2.jpg'
            ...
            <section className={styles.peleador__articles__container}>
                ...
                <article className={styles.peleador__article}>
                    <h2 className={styles.peleador__article__title}>Raquel Pennington Historia</h2>  
                        ...
                        <Image className={styles.peleador__article__image} src={fight2} alt='La luchadora de MMA Raquel Pennington golpeando a su rival de UFC en medio de una pelea' />
