        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Su exitosa carrera la llevó a ganarse una pelea por el título vacante de Peso Gallo Femenino de UFC contra la estadounidense <Link href='/mujeres/raquel-pennington'>Raquel Pennington</Link>, a quien enfrentará el 20 de enero de 2024 por <Link href='/noticias/ufc297'>UFC 297</Link>, protagonizando el combate co-estelar que verá en el combate estelar como se enfrentan <Link href='/campeones/sean-strickland'>Sean Strickland</Link> contra el sudafricano <Link href='/peleadores/dricus-du-plessis'>Dricus Du Plessis</Link> por el título de Peso Mediano de UFC.</p>
