...
export const metadata: Metadata = {
    ...
    description: "Mayra Bueno Silva es una luchadora de la UFC desde que hizo su debut en 2018 en el Dana White's Contender Series Brazil 1, donde ganó por sumisión a la brasileña Mayana Souza, ganandose así un contrato con la compañía. ",
    openGraph: {
        title: 'Mayra Bueno Silva',
        description: "Mayra Bueno Silva es una luchadora de la UFC desde que hizo su debut en 2018 en el Dana White's Contender Series Brazil 1, donde ganó por sumisión a la brasileña Mayana Souza, ganandose así un contrato con la compañía. ",
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Mayra Bueno Silva es una luchadora de la <Link href='/articulos/ufc'>UFC</Link> desde que hizo su debut en 2018 en el Dana White&apos;s Contender Series Brazil 1, donde ganó por sumisión a la brasileña <b>Mayana Souza</b>, ganandose así un contrato con la compañía. </p>
                    ...
                    <p className={styles.peleador__article__text}>Actualmente Mayra cuenta con un récord de 10-4-1-(1), siendo 1 de sus victorias por nocaut, 7 por sumisión y 2 por decisión. Mientras que 1 de sus derrotas fue por nocaut y 3 fueron por decisión. Su único empate fue contra la estadounidense <b>Montana De La Rosa</b>, combate en el que a Mayra se le descontó un punto en el primer asalto por agarrarse a la valla.</p>
                    ...
                    <p className={styles.peleador__article__text}>Su exitosa carrera la llevó a ganarse una pelea por el título vacante de Peso Gallo Femenino de UFC contra la estadounidense <Link href='/mujeres/raquel-pennington'>Raquel Pennington</Link>, a quien enfrentará el 20 de enero de 2024 por <Link href='/covertura-ufc/ufc297'>UFC 297</Link>, protagonizando el combate co-estelar que verá en el combate estelar como se enfrentan <Link href='/peleadores/sean-strickland'>Sean Strickland</Link> contra el sudafricano <Link href='/peleadores/du-plessis'>Dricus Du Plessis</Link> por el título de Peso Mediano de UFC.</p>
