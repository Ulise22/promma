        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Valentina es una peleadora de <Link href='/articulos/ufc'>UFC</Link>, donde pelea desde diciembre de 2015, nacionalizada peruana que se encuentra rankeada #1 en su división y #3 en el libra por libra femenino.</p>
