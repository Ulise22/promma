...
export default function Mackenzie () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={mackenzie} w={16} l={5} d={0} nombre='Mackenzie Dern' apodo={null} categoria='Peso Paja Femenino'  time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Mackenzie Dern posee un récord profesional de 16-5. Siendo 8 de sus 16 victorias por sumisión y 8 por decisión. Mientras que de sus 5 derrotas, sólo 1 fue por nocaut y las otras 4 fueron por decisión.</p>
