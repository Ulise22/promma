        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Raquel Pennington cuenta con un récord de 16-10, 16 victorias de las cuales 1 fue por nocaut que consiguió en su debut como profesional en las MMA, 4 por sumisión y 11 por decisión. Además sus 10 derrotas están compuestas por apenas 1 nocaut, 1 por sumisión y 8 por decisión. </p>
                    ...
                    <p className={styles.peleador__article__text}>Desde entonces ha peleado en la compañía haciendo combates meritorios, compitiendo en una ocasión por el título, que perdería por nocaut técnico, y ganandose la oportunidad de volver a pelear por el campeonato en enero de 2024 contra la brasileña <Link href='/mujeres/mayra-bueno-silva'>Mayra Bueno Silva</Link> en el <Link href='/covertura-ufc/ufc297'>UFC 297</Link>, consiguiendo una victoria por decisión unánime al finalizar los 5 asaltos, convirtiéndose de esta manera en la campeona de peso gallo femenino.</p>
                    <p className={styles.peleador__article__text}>En cuanto a su vida personal, es lesbiana y se casó con la también peleadora de <Link href='/articulos/ufc'>UFC</Link> <b>Tecia Torres</b>, con quie llevaba comprometiada desde 2017.</p>
                </article>
                <AsideFighter />
            </section>
        </main>
