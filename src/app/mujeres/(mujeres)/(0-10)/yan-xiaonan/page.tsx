        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Cortaría esta pequeña racha de derrotas al enfrentar a la estadounidense <Link href='/mujeres/mackenzie-dern'>Mackenzie Dern</Link>, en un evento encabezado por amabas peleadoras, que luego de 5 asaltos terminó en una victoria para la luchadora china por decisión dividida.</p>
                    <p className={styles.peleador__article__text}>Volvería a pelear en mayo de 2023 contra la brasileña <b>Jéssica Andrade</b>, a quien vencería por KO en el primer asalto, ganando su primer premio a la actuación de la noche.</p>
                    <p>Esta victoria, la convirtió en digna retadora al título que ostenta su compatriota <Link href='/mujeres/zhang-weili'>Weili Zhang</Link>, a quien enfrentaría el 13 de abril de 2024 en el <Link href='/covertura-ufc/ufc300-main-event'>UFC 300</Link>, cayendo derrotada por decisión unánime.</p>
                </article>
                <AsideFighter />
            </section>
        </main>
