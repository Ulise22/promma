...
import ufc298 from '@/assets/articulos/heros/10-20/ufc298_hero.jpg'
    ...
    return(
        <section className={styles.articlesFooter}>
            ...
            <article className={styles.articlesPreview__container}>
                ...
                <Link className={styles.articlePreview} href='/articulos/ufc298'>
                ...
                <Link className={styles.articlePreview} href='/articulos/ufc297'>
                ...
                <Link className={styles.articlePreview} href='/articulos/dogfight-wild-tournament-2'>
