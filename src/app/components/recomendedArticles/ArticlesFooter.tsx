        ...
        <section className={styles.articlesFooter}>
            ...
            <article className={styles.articlesPreview__container}>
                <Link className={styles.articlePreview} href='/noticias/ufc302'>
                    ...
                    <h4 className={styles.articlePreview__title}>UFC 302: ¡Islam Makhachev Somete a Poirier en el Último Asalto de la Pelea!</h4>
                </Link>
                ...
                <Link className={styles.articlePreview} href='/articulos/alexander-emelianenko'>
                    ...
                    <h4 className={styles.articlePreview__title}>Alexander Emelianenko: El Hermano de Fedor Emelianenko y su Relación con la Mafia Rusa</h4>
                </Link>
                ...
                <Link className={styles.articlePreview} href='/articulos/mejores-peleadoras-ufc'>
                    ...
                    <h4 className={styles.articlePreview__title}>Las Mejores Peleadoras de la Historia de la UFC</h4>
                </Link>
