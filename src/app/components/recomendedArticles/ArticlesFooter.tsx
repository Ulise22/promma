    ...
    return(
        <section className={styles.articlesFooter}>
            ...
            <article className={styles.articlesPreview__container}>
                <Link className={styles.articlePreview} href=''>
                ...
                <Link className={styles.articlePreview} href=''>
                    <Image className={styles.articlePreview__image} src={top5} alt='UFC 300' />
                    <h4 className={styles.articlePreview__title}>TOP5: Mejores Peleadores de la Historia de la UFC</h4>
                </Link>
                <Link className={styles.articlePreview} href=''>
                    <Image className={styles.articlePreview__image} src={khabibVferguson} alt='UFC 300' />
