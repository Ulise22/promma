        ...
        <section className={styles.articlesFooter}>
            ...
            <article className={styles.articlesPreview__container}>
                <Link className={styles.articlePreview} href='/noticias/ufc302'>
                    ...
                    <h3 className={styles.articlePreview__title}>UFC 302: ¡Islam Makhachev Somete a Poirier en el Último Asalto de la Pelea!</h3>
                </Link>
                <Link className={styles.articlePreview} href='/noticias/ufc298'>
                    <Image className={styles.articlePreview__image} src={ufc298} alt='' />
                    <h3 className={styles.articlePreview__title}>UFC 298: Ilia Topuria Noquea a Volkanovski y es Nuevo Campeón de UFC</h3>
                </Link>
                ...
                <Link className={styles.articlePreview} href='/articulos/khabib-ferguson'>
                    ...
                    <h3 className={styles.articlePreview__title}>Khabib vs Ferguson: La pelea maldita que nunca se pudo hacer</h3>
                </Link>
                <Link className={styles.articlePreview} href='/noticias/dogfight-wild-tournament-2'>
                    ...
                    <h3 className={styles.articlePreview__title}>Lo Mejor de Dogfight Wild Tournament, el Evento de Combate Más Loco Organizado por Jordi Wild</h3>
                </Link>
            </article>
        </section>
    )
