    ...
    return(
        <section className={styles.articulos}>
            ...
            <article className={styles.articulos__container}>
                ...
                <HomeArticle img={llegarAUFC5Pasos} link='/articulos/como-llegar-a-la-ufc' title='Descubre Como Llegar a la UFC en 5 pasos' author={null} description='Convierte tu sueño en realidad: Sigue estos 5 pasos para llegar a la UFC y ser un peleador profesional' date='24/01/2025' />
