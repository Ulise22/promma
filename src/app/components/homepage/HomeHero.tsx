    ...
    return(
        <section className={styles.homehero}>
            <Link className={styles.homehero__bigArticle} href='/eventos/ufc330'>
                ...
                <h2 className={styles.home__title}>UFC 330: ¡Islam Makhachev vs Ian Garry! ¡Mackenzie Dern Derrota a Gillian Robertson por Decisión Unánime y Retiene el Cinturón!</h2>
