    ...
    return(
        <section className={styles.noticias}>
            ...
            <article className={styles.noticiasHero}>
                <Link className={styles.noticiasHero__bigArticle} href='/noticias/fight-night-cannonier-imanov'>
                    <Image className={styles.noticiasHero__bigArticle__img} src={cannonierVSimano} alt='' />
                    <h2 className={styles.page__title}>UFC Fight Night: ¡Imanov Noquea a Canonnier! ¡Dominick Reyes Gana por Nocaut en el Primer Asalto! y ¡Raul Rosas JR Somete en el Segundo Asalto!</h2>
                    <p>El UFC Fight Night Canonnier vs Imanov, nos dejó 5 nocauts, 1 sumisión y un montón de peleas espectaculares que valen la pena ver, en una cartelera organizada en la ciudad de Loisville en el Estado de Kentucky.</p>
                </Link>
