...
import ponzinibbio from '../../../../assets/peleadores__images/santiago-ponzinibbio/ponzinibbio.png'
import santiagoArgentina from '../../../../assets/peleadores__images/santiago-ponzinibbio/ponzinibbio-argentina.jpg'
import pelea from '../../../../assets/peleadores__images/santiago-ponzinibbio/ponzinibbio-peleando.jpg'
import santiago_ponzinibbio from '../../../../assets/peleadores__images/santiago-ponzinibbio/ponzinibbio.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={santiago_ponzinibbio} alt='Santiago Ponzinibbio aplaudiendo y sonriendo luego del pesaje previo a una pelea de ufc' />
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p>Su actuación destacada en TUF, le hizo ganarse un contrato con UFC, donde pese a perder en su debut contra Ryan LaFlare, supo mantenerse activo durante 10 años peleando para dicha compañía.</p>
                </article>
                <article className={styles.peleador__article}>
