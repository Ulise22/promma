        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Charles Oliveira es actualmente el número #1 de la división de Peso Ligero de la <Link href='/promotoras/ufc'>UFC</Link> y ha sido campeón en una ocación luego de que venciera por TKO al estadounidense <Link href='/peleadores/michael-chandler'>Michael Chandler</Link> en el segundo asalto, por el título vacante de Peso Ligero en UFC 262 luego del retiro de <b>Khabib Nurmagomédov</b>. A dicho título lo defendió de forma exitosa 2 veces, contra <Link href='/peleadores/dustin-poirier'>Dustin Poirier</Link> y contra <Link href='/peleadores/justin-gaethje'>Justin Gaethje</Link>.</p>
