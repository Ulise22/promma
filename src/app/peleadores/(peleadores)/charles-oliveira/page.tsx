...
import face from '@/assets/peleadores__images/charles-oliveira/oliveira-face.jpg'
import interview from '@/assets/peleadores__images/charles-oliveira/charles-oliveira.jpg'
import scream from '@/assets/peleadores__images/charles-oliveira/charles_oliveira.jpg'
import back from '@/assets/peleadores__images/charles-oliveira/charles__oliveira.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Charles Oliveira es actualmente el número #1 de la división de Peso Ligero de la <Link href='/promotoras/ufc'>UFC</Link> y ha sido campeón en una ocación luego de que venciera por TKO al estadounidense Michael Chandler en el segundo asalto, por el título vacante de Peso Ligero en UFC 262 luego del retiro de <b>Khabib Nurmagomédov</b>. A dicho título lo defendió de forma exitosa 2 veces, contra Dustin Poirier y contra Justin Gaethje.</p>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Charles Oliveira e <Link href='/campeones/islam-makhachev'>Islam Makhachev</Link> se enfrentaron, luego de que Oliveira haya obtenido el cinturón de Peso Ligero de UFC al vencer a <b>Michael Chandler</b>, y luego de que tuviera 2 defensas exitosas por el título contra <Link href='/peleadores/justin-gaethje'>Justin Gaethje</Link> y contra <Link href='/peleadores/dustin-poirier'>Dustin Poirier</Link>.</p>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Su última pelea fue en UFC 289 el 10 de junio de 2023 contra el estadounidense Beneil Dariush, a quien enfrentó luego de su derrota contra Islam Makhachev. La pelea la terminó ganando el brasileño por TKO a los 4 minutos del primer asalto, lo que le sirvió para extender su el récord de mayor cantidad de finalizaciones que hacía tiempo sostenía a 20, y dicha pelea le hizo ganador una vez más a la Actuación de la Noche, lo que conlleva otro record a la mayor cantidad de bonos post-pelea en la UFC con 19. </p>
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/qDSdudtsz1A?si=fbtxkfi2nyglTP9z" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </article>
            </section>
        </main>
    )
