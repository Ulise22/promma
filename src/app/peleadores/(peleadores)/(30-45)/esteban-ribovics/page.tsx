...
export default function Ribovics () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={13} l={1} d={0} nombre='Esteban Ribovics' apodo='EL GRINGO' categoria='Peso Ligero' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Esteban Ribovics posee un récord profesional de 13-1. Siendo 7 de sus victorias por la vía del nocaut, 5 por la vía de la sumisión y sólo 1 por decisión. Mientras que su única derrota profesional fue por decisión de los jueces.</p>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/uz4ojHVLwH0?si=1VPYw9jsRgaAHc9T" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/WACHBDrjYkw?si=qhGgsakbsipGrhUG" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/lYVVBcwVSIE?si=TbD87Uo_ZD2OeX6z" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/CExoos0xrnc?si=XjIReI4KlVacLhJx" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/fo74Trl91u8?si=VW7tKKfv3PE4VVVP" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <blockquote className={`${styles.article__twitter__video} twitter-tweet`} data-media-max-width="560"><p lang="en" dir="ltr">HE ONLY NEEDED 35 SECONDS ‼️<br /><br />Esteban Ribovics gets the early KO! <a href="https://twitter.com/hashtag/UFCStLouis?src=hash&amp;ref_src=twsrc%5Etfw">#UFCStLouis</a> <a href="https://t.co/17Ta7sl7Qz">pic.twitter.com/17Ta7sl7Qz</a></p>&mdash; UFC (@ufc) <a href="https://twitter.com/ufc/status/1789421694257414240?ref_src=twsrc%5Etfw">May 11, 2024</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" ></script>
                    <p className={styles.peleador__article__text}>Aunque lo más difícil aún está por venir para Esteban, dado que estará en la cartelera principal del <b>UFC 306</b>, en la Esfera de las Vegas, donde deberá enfrentarse al mexicano <b>Daniel Zellhuber</b>, quien tiene un récord de 15-1, en territorio hóstil, dado que dicha cartelera está plagada de mexicanos, y la fecha en la que se realizará dicho evento, coincide con el día de la independencia de México, lo que tendrá a Ribovics probablemente con el público en contra.</p>
                </article>
                <AsideChamps />
            </section>
        </main>
