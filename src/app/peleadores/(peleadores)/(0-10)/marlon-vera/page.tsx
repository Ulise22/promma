        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p>Hoy en día luego de 22 combates en la compañía, en la cual lleva 15 victorias y 7 derrotas, se ha ganado la oportunidad de pelear por el título de la división contra el recientemente proclamado campeón <Link href='/campeones/sean-omalley'>Sean O&apos;Malley</Link>, a quien ya había enfrentado en una ocasión. Aquel combate que tuvieron se dió en el UFC 252 en Las Vegas, donde Chito Vera logró ganar por nocaut en el primer asalto, convirtiéndose, hasta el momento, en el único peleador en ganarle a O&apos;Malley, porque recordemos que Sean actualmente tiene un record de 17-1, y ese 1 es el que consiguió poner Marlon Vera.</p>
                    <p>Para cuanto tuvo lugar aquel primer enfrentamiento que tuvieron, Sean O&apos;Malley llegaba con un récord de 12-0, luego de ganar por KO contra el estadounidense <b>Eddie Wineland</b>. En medio de la pelea O&apos;Malley se lesionó el pie, y tiempo después Vera aprovechó esto para terminar llevandose el combate al tirarlo al suelo e iniciar el ground and pound, golpeandolo en el suelo que llevó al arbitro a dar por terminado al combate en favor del ecuatoriano.</p>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p>Vera haría su debut profesional como luchador en junio de 2011, cuando se enfrentaría al luchador colombiano <b>César Moreno</b>, a quien derrotaría por decisión unánime luego de 3 asaltos. Tendría unas peleas más en campeonatos de la región latinoamericana hasta que en 2014, luego de postularse, sería aceptado como participante del reality organizado por la UFC <b>The Ultimate Fighter</b>. En dicha participación pelearía contra el experimentado <b>Henry Bure</b> a quien lograría noquear, ganandose así su paso a la semifinal. Sin embargo, antes de que esta lograra concretarse, Vera sufrió un problema en la piel que lo llevó a retirarse del programa para ser reemplazado por el argentino <Link href='/argentinos/guido-cannetti'>Guido Canneti</Link>, con quien se enfrentaría en el futuro y ganaría por sumisión en el segundo asalto en el <b>UFC Fight Night: Magny vs. Ponzinibbio</b> organizado en Buenos Aires, Argentina.</p>
                    <p>Luego de la participación de Chito en el programa, se ganaría un contrato con la UFC en donde haría el ya mencionado debut contra <b>Marco Beltrán</b>, quien lo venció por decisión. Sin embargo desde entonces tuvo una destacable participación en su división, ganando el bono de la actuación de la noche 5 veces, el de la pelea de la noche 3 veces y siendo él quien cuenta con el récord de la mayor cantidad de finalizaciones de la historia de Peso Gallo en UFC, con un total de 10.</p>
                    <p>También se ganó la oportunidad de pelear contra quien ya supo vencer en una ocasión, <Link href='/campeones/sean-omalley'>Sean O&apos;Malley</Link> por el título de la división, el 9 de marzo de 2024 en el UFC 299. Como dato, ambos peleadores, junto a al estadounidense <b>Rob Font</b>, comparten el récord de mayor cantidad de nocauts en la divisón de peso gallo de la UFC, ¿logrará Chito Vera desempatar este récord?</p>
                    <p>En cuanto a su vida personal, Vera está casado con su esposa María, con quien tiene 2 hijas nacidas en 2011 y 2018, y un hijo nacido en 2015. </p>
                </article>
            </section>
        </main>
    )
