        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Dustin Poirier es un peleador estadounidense de MMA que actualmente se encuentra #3 en los rankings de Peso Ligero de la <Link href='/promotoras/ufc'>UFC</Link>. Ha llegado a ser campeón interino de su división, luego de ganarle por decisión unánime a <Link href='/peleadores/max-holloway'>Max Holloway</Link> en UFC 236. Aunque luego perdería sus 2 oportunidades de ganar el título de Peso ligero, primero con <Link href='/leyendas/khabib-nurmagomedov'>Khabib Nurmagomédov</Link>, a quien enfrentó en UFC 242 poco después de vencer a Holloway, la pelea terminaría en una victoria para el ruso en el tercer asalto por una sumisión. Su segunda oportunidad por el título sería cuando este estuviera en manos de <Link href='/peleadores/charles-oliveira'>Charles Oliveira</Link>, quien lo venció también con una sumisión en el tercer asalto.</p>
