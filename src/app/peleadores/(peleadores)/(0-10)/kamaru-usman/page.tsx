        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Desde entonces ha peleado varios años en la <Link href='/articulos/ufc'>UFC</Link>, maneteniendo un invicto en la compañía que sólo sería roto en agosto de 2022, luego de un poco menos de 7 años en la compañía.</p>
