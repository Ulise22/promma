        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p>Colby Covington es un peleador de MMA estadounidense que compite en la División de Peso Wélter de la <Link href='/articulos/ufc'>UFC</Link>, donde se encuenta ranqueado #2 luego de casi 10 años de competir. Desde que hiciera su debut en el <b>UFC Fight Night: Bisping vs. Le</b> contra el luchador chino <b>Anying Wang</b>, a quien noqueó en el primer asalto, ha luchado un total 16 veces en la compañía, ganando 12 de esos 16 combates.</p>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/GT7IpRlrlGE?si=Lk-NI_WJmJwMcsbq" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <p>Desde entonces pelea en la UFC, y aunque no llegó a ser campeón, tuvo la oportunidad en 3 ocasiones, siendo la última en diciembre de 2023 contra <Link href='/peleadores/leon-edwards'>Leon Edwards</Link>.</p>
