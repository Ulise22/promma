...
import belt from '@/assets/peleadores__images/max-holloway/holloway_belt.jpg'
import girl from '@/assets/peleadores__images/max-holloway/holloway_girl.jpg'
import pelea from '@/assets/peleadores__images/max-holloway/holloway_pelea.jpg'
import traje from '@/assets/peleadores__images/max-holloway/holloway_traje.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Max Holloway y <Link href='/campeones/alexander-volkanovski'>Alexander Volkanovski</Link> se han enfrentado 3 veces en total. La primera siendo por el título de Peso Pluma de UFC, que sostenía Holloway desde hacía tiempo y que venía defendiendo de forma exitosa. En aquella ocasión, Alexander Volkanovski ganaría por decisión unánime en una pelea que sin embargo no fue tan contundente para el australiano.</p>
