        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Merab posee un récord de 17-4. Siendo 3 de sus victorias por la vía del nocaut, 1 por sumisión y 13 por decisión. Mientras que de sus 4 derrotas, 1 fue por sumisión y 3 por decisión.</p>
                    ...
                    <p className={styles.peleador__article__text}>Su segundo combate sería el 21 de abril de 2018 ante <b>Ricky Simón</b>, donde volvería a caer derrotado, esta vez por sumisión técnica, de una forma curiosa, puesto que Merab estuvo encerrado en una guillotina durante casi un minuto entero, aunque se mantuvo durante todo este tiempo consciente y sin tapear en ningún momento, hasta que finalmente terminó la pelea y su rival se llevó la victoria. De igual forma, este combate le haría ganar a nuestro protagonista su primer bono en la UFC, al ser elegida esta como la pelea de la noche.</p>
