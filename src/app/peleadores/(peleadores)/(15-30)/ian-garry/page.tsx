        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ian Machado Garry tiene un récord profesional en las MMA de 15-0. Siendo 7 de sus victorias por la vía del nocaut, sólo 1 de sus victorias fue por sumisión y siendo 7 de sus victorias fueron por decisión.</p>
