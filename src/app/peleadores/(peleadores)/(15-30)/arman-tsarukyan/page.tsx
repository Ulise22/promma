        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/dmTKu3R7mXU?si=AukA9OEmF4w5vLAJ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <p className={styles.peleador__article__text}>Luego de su debut con derrota en la compañía, acumularía una racha de 5 victorias consecutivas, donde las primeras 3 de esas victorias serían por decisión, contra los rivales <b>Olivier Aubin-Mercier, Davi Ramos y Matt Frevola</b>, y donde las siguientes 2 victorias serían por nocaut, contra el estadounidense <b>Christos Giagos</b> y contra el español <Link href='/peleadores/joel-alvarez'>Joel Álvarez</Link>, a quienes vencería en el primer y segundo asalto, respectivamente. Aquella racha se vería interrumpida al enfrentarse y caer derrotado por decisión contra un hueso duro de roer en la división como lo es el polaco <b>Mateusz Gamrot</b>, en un evento que encabezarían ellos 2.</p>
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/vHrXAB0SzSc?si=1aNEk4hFNM4afSNZ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <p className={styles.peleador__article__text}>Sin embargo, Tsarukyan supo reponerse bien de la derrota acumulando otras 3 victorias consecutivas, siendo la más destacada de ellas, su victoria por KO contra el estadounidense <b>Beneil Dariush</b> en el primer asalto, que lo ubicó en una posición favorable para enfrentar a <Link href='/peleadores/charles-oliveira'>Charles Oliveira</Link> en el <Link href='/covertura-ufc/ufc300-main-event'>UFC 300</Link>, en lo que sería una eliminatoria por el título de peso ligero de la UFC.</p>
                </article>
                <AsideChamps />
            </section>
        </main>
