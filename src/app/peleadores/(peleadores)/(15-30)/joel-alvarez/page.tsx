...
import fighter from '@/assets/peleadores__images/30-40/joel-alvarez/joel_alvarez.png'
...
export default function JoelAlvarez () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={21} l={3} d={0} nombre='Joel Álvarez' apodo='EL FENÓMENO' categoria='Peso Ligero' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Joel Álvarez mantiene un récord profesional de 21-3. Siendo 5 de sus victorias por la vía del nocaut y 16 por la vía de la sumisión. Mientras que de sus 3 derrotas, 2 fueron por la vía del nocaut y sólo 1 fue por decisión.</p>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/dcieqXjinFM?si=U0yDpdoY9bAuNUTV" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <p className={styles.peleador__article__text}>En promotora es donde lograría consagrarse como campeón de Peso Ligero, al lograr someter en el primer asalto al italiano <b>Radu Maxim</b>. Esta sería su última pelea en la promotora, dado que con su destacada trayectoria y siendo bastante joven, con un récord en ese entonces de 15-1, lograría firmar un contrato con la UFC para luchar allí y formar parte de la compañía.</p>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/h8jT0BFO6fc?si=nAoyIpFjx5Kg__5q" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/X4TEAtjrGU4?si=rfCmWd6-Xb2b4anq" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/v6c_KMa49KM?si=r2v1_J2UkkQStRE-" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <p className={styles.peleador__article__text}>Volvería a pelear el 3 de agosto de 2024 ante el brasileño <b>Elves Brener</b> en el <Link href='/noticias/fight-night-sandhagen-nurmagomedov'>UFC Fight Night: Sandhagen vs Nurmagomedov</Link>, a quien vencería por TKO en el tercer asalto, logrando su primer bono en la compañía a la actuación de la noche, y cumpliendo con una finalización al igual que todas las victorias de su carrera.</p>
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/x8ZpZkz0s_s?si=vg7BbA9CD9KxyvOM" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
