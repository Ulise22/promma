        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Shara &quot;Bullet&quot; es un peleador ruso de la república de Daguestán, al igual que muchos de los peleadores más reconocidos de la UFC, como <Link href='/leyendas/khabib-nurmagomedov'>Khabib</Link>, <Link href='/peleadores/islam-makhachev'>Islam Makhachev</Link> o <b>Ankalaev</b>. Lleva peleando en la <Link href='/articulos/ufc'>UFC</Link> desde octubre de 2023, cuando enfrentó al ruso <b>Bruno Silva</b> en el UFC 294, ganando su combate por decisión unánime.</p>
                    <h2 className={styles.peleador__article__title}>Shara Magomedov Récord</h2>
                    <p className={styles.peleador__article__text}>Shara Magomedov tiene un récord invicto profesional de 14-0 en lo que lleva de su carrera en las MMA. Siendo 11 de sus victorias por la vía del nocaut y sólo 3 por decisión. </p>
                    ...
                    <p className={styles.peleador__article__text}>En su segundo combate, se programó una pelea contra <b>Ihor Potieria</b> en el <Link href='/noticias/fight-night-whittaker-aliskerov'>UFC FIGHT NIGHT: Whittaker vs Aliskerov</Link>, pero esto no pudo estar presente dado que terminó aceptando una pelea de último minuto ante el brasileño <b>Michel Pereira</b> en el <Link href='/noticias/ufc301'>UFC 301</Link>. En su lugar se le puso a otro peleador llamado <b>Joilton Lutterbach</b> que tampoco pudo decir presente ya que fue suspendido por dar positivo de sustancias prohibidas. Finalmente se enfrentó al brasileño <b>Antonio Trócoli</b>, a quien logró noquear en el tercer asalto, ganando su primer bono en la compañía a la actuación de la noche.</p>
                    ...
                    <p className={styles.peleador__article__text}>En su tercer pelea en la UFC, se enfrentaría al polaco <b>Michał Oleksiejczuk</b> en el <Link href='/noticias/fight-night-sandhagen-nurmagomedov'>UFC FIGHT NIGHT: Sandhagen vs Nurmagomedov</Link>. Esta pelea la ganaría por decisión unánime en lo que fue actuación destacada, ganándose su segundo bono en la compañía, esta vez a la pelea de la noche.</p>
                    </article>
                <AsideChamps />
            </section>
        </main>
