        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Emiliano Sordi es un peleador de mma argentino, que ha llegado a competir en diversas compañías como <b>Bellator</b> y <b>PFL</b>, que destacó en 2019 al consagrarse campeón mundial de los semicompletos en la compañía PFL (Professional Fighters League).</p>
