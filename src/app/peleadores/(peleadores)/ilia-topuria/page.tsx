        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>En su última pelea en junio de 2023, venció por decisión unánime a Josh Emmet, logrando de esta forma para muchos, ser merecedor de una pelea por el título contra <Link href='/campeones/alexander-volkanovski'>Alexander Volkanovski</Link></p>
