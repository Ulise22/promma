        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Justin Gaethje actualmente se encuentra ranqueado número #2 en la división de Peso Ligero de <Link href='/articulos/ufc'>UFC</Link> donde pelea desde 2017, habiendo hecho su debut en The Ultimate Fighter contra Michael Johnson el 7 de julio en Las Vegas, ganando por TKO en el segundo asalto, y habiendo hecho su debut en un evento de UFC el 2 de diciembre en UFC 218 contra <b>Eddie Alvarez</b>, quien lo venció por TKO en el tercer asalto.</p>
                    ...
                    <p className={styles.peleador__article__text}>El 29 de julio de 2023, Justin Gaethje se enfrentaría a <Link href='/peleadores/dustin-poirier'>Dustin Poirier</Link> por el título BMF (Badest Mother Fucker), que según a dicho la UFC <b>Premia a los que tienen las agallas de para producir un momento estelar tras otro</b> cada vez que pelean. Por lo que desde que lo ganara <b>Jorge Masvidal</b> contra <Link href='/articulos/nate-diaz-historia'>Nate Días</Link>, Dana White ha decidido poner otra vez en juego este cinturón, enfrentando a 2 de los favoritos de la división.</p>
                    ...
                    <p className={styles.peleador__article__text}>Además, Justin Gaethje sería el primer peleador en defender este cinturón, ya que Masvidal no lo había hecho, enfrentando en el <Link href='/covertura-ufc/ufc300-main-event'>UFC 300</Link> al luchador de una división inferior pero siempre peligroso <Link href='/peleadores/max-holloway'>Max Holloway</Link>, contra quien lamentablemente caería derrotado en el último segundo del quinto y último asalto, en lo que sin dudas será un momento histórico y recordado por todos los fans de las MMA.</p>
                    </article>
                <AsideChamps />
            </section>
        </main>
