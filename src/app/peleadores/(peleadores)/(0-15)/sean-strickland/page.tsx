        ...
        <main> 
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Sean Strickland es un peleador estadounidense de MMA que compite en la compañía <Link href='/articulos/ufc'>UFC</Link>, y es excapeón de Peso Medio de UFC, luego de que quien en su momento llegó a ocupar el 5to lugar en su división, le arrebatara el título a <Link href='/peleadores/israel-adesanya'>Israel Adensanya</Link>.</p>
                    ...
                    <p className={styles.peleador__article__text}>En Agosto de 2023, Sean Strickland recibió un llamado en corto aviso, en el que le pidieron que reemplazara a <Link href='/peleadores/du-plessis'>Du Plessis</Link>, en el combate contra el campeón del Peso Medio de la UFC, Israel Adensanya.</p>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/m3jNtOxIyDA?si=jf40ROC8sQsSW9LR" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
