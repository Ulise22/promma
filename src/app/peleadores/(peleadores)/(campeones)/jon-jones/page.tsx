...
import careo from '@/assets/peleadores__images/jon-jones/jon-jones-vs.jpg'
import kick from '@/assets/peleadores__images/jon-jones/jon-jones_pelea2.jpg'
import kick2 from '@/assets/peleadores__images/jon-jones/jon-jones_pelea3.jpg'
import punch from '@/assets/peleadores__images/jon-jones/jon-jones_pelea.jpg'
import pesaje from '@/assets/peleadores__images/jon-jones/jon_jones.jpg'
import win from '@/assets/peleadores__images/jon-jones/jon-jones.jpg'
        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={win} alt='Jon Jones festejando su victoria de UFC luego de noquear a un rival' />
                </article>
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={kick} alt='Jon Jones pateando al cuerpo a un rival en un combate de UFC' />
                ...
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={pesaje} alt='Jon Jones en el pesaje previo a su pelea por UFC 214' />
                    ...
                    <Image className={styles.peleador__article__image} src={kick2} alt='Jon Jones pateando em la cabeza a un rival en un combate de UFC' />
                </article>
                <article className={styles.peleador__article}>
