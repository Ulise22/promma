...
export default function Dvalishvili () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={18} l={4} d={0} nombre='Merab Dvalishvili' apodo='THE MACHINE' categoria='Peso Gallo' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Merab posee un récord de 18-4. Siendo 3 de sus victorias por la vía del nocaut, 1 por sumisión y 14 por decisión. Mientras que de sus 4 derrotas, sólo 1 fue por sumisión y 3 por decisión.</p>
