...
export default function Pantoja () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={pantoja} w={30} l={7} d={0} nombre='Alexandre Pantoja' apodo='THE CANNIBAL' categoria='Peso Mosca'  time='2026-09-23' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Alexandre Pantoja tiene un record de 30-7-0, siendo 8 de sus 27 victorias por nocaut, 12 por sumisión y 10 por decisión. Mientras que de sus derrotas 6 fueron por decisión y sólo 1 por la vía del nocaut.</p>
