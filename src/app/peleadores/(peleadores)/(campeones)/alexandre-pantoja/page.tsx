...
export default function Pantoja () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={pantoja} w={30} l={5} d={0} nombre='Alexandre Pantoja' apodo='THE CANNIBAL' categoria='Peso Mosca'  time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Alexandre Pantoja tiene un record de 30-5-0, siendo 8 de sus 27 victorias por nocaut, 12 por sumisión y 10 por decisión. Mientras que todas sus 5 derrotas fueron por decisión.</p>
