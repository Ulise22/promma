        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Su segunda defensa del título tendría lugar nada más y nada menos que en su casa, en Brasil, donde encabezando el <Link href='/noticias/ufc301'>UFC 301</Link>, organizado el 4 de mayo de 2024, enfrentaría al australiano <b>Steve Erceg</b>, a quien vencería por decisión unánime.</p>
