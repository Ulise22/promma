        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p>Luego de aquella primer derrota de su carrera, Sean O&apos;Malley obtendría otras 3 victorias consecutivas, todas por la vía del nocaut, contra los peleadores <b>Thomas ALmeida</b>, <b>Kris Moutinho</b> y <b>Raulian Paiva</b>. Su siguiente combate luego de ese sería contra el brasileño <b>Pedro Munhoz</b>, a quien le terminó dando un piquete en el ojo en el segundo asalto de la pelea que le impidió seguir peleando, por lo que la pelea quedó sin resultado.</p>
                    <p>Su siguiente pelea sería contra el luchador ruso excampeón de la división, <b>Petr Yan</b>, a quien enfrentó en el UFC 280 el 22 de octubre de 2022. En lo que fue un combate cerrado a 3 asaltos, el estadounidense se terminó llevando la pelea por decisión dividida. Esta victoria sería la que le daría la chance de disputar el título de peso gallo.</p>
                    <p>Por lo que el 19 de agosto de 2023 en el UFC 292 se enfrentaría al campeón <b>Aljamain Sterling</b>, que ya llevaba 3 defensas del título, por el Campeonato de Peso Gallo de UFC. La pelea la ganaría nuestro protagonista por TKO en el primer minuto del segundo asalto, ganando el bono a la actuación de la noche y conviriténdose en el nuevo campeón de la división de peso gallo de la UFC.</p>
                    ...
                    <p>Luego de aquella meritoria victoria, Sean haría su primera defensa del título contra el #6 ranqueado de la división, y contra el único peleador que hasta entonces había sido capaz de derrotarlo, <Link href='/peleadores/marlon-vera'>Chito Vera</Link>, a quien enfrentaría en el <Link href='/noticias/ufc299'>UFC 299</Link>. Omalley se llevaría la victoria merecidamente luego de 5 asaltos por decisión unánime, ganando nuevamente el bono a la actuación de la noche.</p>
                </article>
                <AsideFighter />
            </section>
        </main>
