        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>El 1 de junio de 2024 volvería a defender su título en <Link href='/noticias/ufc302'>UFC 302</Link>, siendo el retador un <Link href='/peleadores/dustin-poirier'>Dustin Poirier</Link>, que venía de una victoria por nocaut en <Link href='/noticias/ufc299'>UFC 299</Link>, y que al estar en sus 35 años, veía este combate como su última oportunidad para ser campeón. En un combate donde el retador dió todo, nuestro protagonista supo demostrar de lo que está hecho, sometiendo en el quinto asalto a Poirier, ganando el bono a la actuación de la noche y a la pelea de la noche.</p>
                    </article>
                <AsideFighter />
            </section>
        </main>
