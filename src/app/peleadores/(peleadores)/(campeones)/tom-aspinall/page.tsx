        ...
        <main> 
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Tom Aspinall es un peleador inglés de MMA que compite en la división de Peso Pesado de la <Link href='/articulos/ufc'>UFC</Link>, en donde está ranqueado #1 actualmente, además de ser el campeón interino de dicha división. Además, se encuentra ranqueado #12 en el libra por libra de la UFC.</p>
