        ...
        <main> 
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Sean Strickland es un peleador estadounidense de MMA que compite en la compañía UFC, y es el actual capeón de Peso Medio de UFC, luego de que quien en su momento llegó a ocupar el 5to lugar en su división, le arrebatara el título a <b>Israel Adensanya</b>.</p>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/MU-slc5rg2g?si=YJTSTQMShax9hw2D" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </article>
            </section>
        </main>
    )
