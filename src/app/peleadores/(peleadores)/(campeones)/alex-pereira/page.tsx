        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Alex Pereira es el actual campeón de Peso Semipesado de UFC y es el número #5 libra por libra de la UFC, luego de que recientemente derrotará por nocaut a su rival <b>JIŘÍ PROCHÁZKA</b> en el segundo asalto, ganando así el título que había quedado vacante en la división.</p>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={alex} alt='Imagen de Alex Pereira después de su pesaje previo a su combate contra Jan Nlachowicz en Peso Semipesado de UFC' />
