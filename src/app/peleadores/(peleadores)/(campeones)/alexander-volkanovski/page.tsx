        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p>Alexander Volkanovski es un peleador de mma australiano, vigente campeón de Peso Ligero de UFC. Desde su ingreso en la compañía en 2016 disputo 15 combates, ganando 13 de estos, venciendo peleadores históricos como <b>José Aldo</b>, o <b>Max Holloway</b>.</p>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <p>Volkanovski tiene un recor impresionante en mma. Ha ganado 26 combates y sólo ha perdido 3, siendo 2 de estos contra un luchador más pesado que él, como lo es <Link href='/peleadores/islam-makhachev'>Islam Makhachev</Link>, y la otra siendo por un TKO en los inicios de su carrera hace ya más de 10 años.</p>
                ...
                <article className={styles.peleador__article}>
                    ...
                    <Image className={styles.peleador__article__image} src={pelea} alt='El campeón de UFC y luchador de MMA Alexander Volkanovski en el suelo siendo estranguladdo por el también peleador de ufc Brian Ortega en su combate de UFC 266' />
