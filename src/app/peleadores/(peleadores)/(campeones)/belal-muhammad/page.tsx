...
export default function BelalMuhammad () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={belal} w={24} l={5} d={0} nombre='Belal Muhammad' apodo='Remember The Name' categoria='Peso Wélter'  time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Belal Muhammad posee un récord de 24-5 (1). Siendo 5 de sus victorias por la vía del nocaut, 1 por la vía de la sumisión y 18 por decisión. Mientras que de sus 5 derrotas, 1 fue por nocaut y 4 fueron por decisión. Además tiene una pelea ante <b>Leon Edwards</b> que quedó sin resultado, luego de que esta sea parada en medio del segundo asalto, debido a un golpe accidental en el ojo que le impidió a Belal continuar peleando.</p>
