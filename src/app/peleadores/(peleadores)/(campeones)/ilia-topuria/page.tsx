        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ya en su temprana adultez decidió dejar un poco los estudios de lado y lanzarse de lleno en su carrera como artista marcial mixto, teniendo que compaginar su carrera con varios trabajos que realizaba para subsistir, como cajero de una tienda y como seguridad privada. </p>
                    ...
                    <p className={styles.peleador__article__text}>Al vencer a Emmett, Topuria se sentía listo para pelear por el título, por lo que no dudo en llamar al entonces campeón <Link href='/peleadores/alexander-volkanovski'>Alexander Volkanovski</Link>, que en una previa donde Ilia se dedicó a hablar hasta por los codos, afirmando que podría noquear al campeón de la división, terminó respaldando sus palabras con hechos, al propinarle un KO en el segundo asalto a Volkanovski, el 17 de febrero de 2024, consagrándose así, como nuevo campeón de Peso Pluma de UFC.</p>
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/Ahi-btqB8N4?si=-mXcLqdCAEGqNQbH" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </article>
                <AsideFighter />
            </section>
        </main>
