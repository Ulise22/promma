...
export default function Illia () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={topuria} w={17} l={1} d={0} nombre='Ilia Topuria' categoria='Peso pluma (featherweight)' apodo='El Matador' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ilia Topuria posee un récord profesional de MMA de 17-1. Siendo 7 de sus victorias por nocaut, 8 por sumisión y tan sólo 2 por decisión. Mientras que su única derrota fue por TKO. </p>
