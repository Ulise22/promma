        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Max Holloway es un peleador estadounidense que actualmente compite en la división de peso pluma de la <Link href='/articulos/ufc'>UFC</Link>, donde en el pasado llegó a ser campeón interino de Peso Pluma luego derrotar por TKO en el tercer asalto a Anthony Pettis en UFC 206, y luego reafirmó su título al vencer por TKO en el tercer asalto también, contra el histórico <Link href='/leyendas/jose-aldo'>José Aldo</Link>, luego de eso, Holloway defendió de forma exitosa 3 veces su título hasta que lo perdió contra <Link href='/peleadores/alexander-volkanovski'>Alexander Volkanovski</Link>.</p>
