        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p>Ha peleado un total de 10 veces en la compañía, teniendo en UFC un récord de 8-2, siendo ambas derrotas por decisión.</p>
