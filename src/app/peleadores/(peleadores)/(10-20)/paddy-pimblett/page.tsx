...
export default function Pimblett () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={pimblett} w={21} l={3} d={0} nombre='Paddy Pimblett' categoria='Peso Ligero' apodo='THE BADDY' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p>Paddy considera que su caraterístico pelo suelto y la falta de tatuajes en su cuerpo, es lo que permite a los niños identificarse con él, dado que es especialmente popular en la audiencia joven de las MMA, a quienes les es más fácil identificarse con un tipo como Paddy antes que con el &quot;tipo grande y duro con muchos tatuajes&quot;.</p>
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/VDLmgJPydsQ?si=MYXXL8R50R6NHNsh" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    <h2 className={styles.peleador__article__title}>Paddy Pimblett Récord</h2>
                    <p className={styles.peleador__article__text}>Paddy Pimblett posee un récord profesional de 21-3. Siendo 6 desus victorias por la vía del nocaut, 9 por la vía de la sumisión y 6 por decisión. Mientras que de sus 3 derrotas, 1 fue por sumisión y 2 fueron por decisión.</p>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/YQRSGJRHsx0?si=ZFeSTp6O46-3hwiS" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/dx7gZjFDa-4?si=gKFbjwpN0ZdGnbcL" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/X82ClCsaAKs?si=SfipelrqHKzgzqEy" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/iYIudNEXRfw?si=Ryy2R9UMIm0x-VLn" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} width="560" height="315" src="https://www.youtube.com/embed/Z8XZ_Ziu4VM?si=12FevTwvz0nG_beg" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                </article>
                <AsideChamps />
            </section>
        </main>
