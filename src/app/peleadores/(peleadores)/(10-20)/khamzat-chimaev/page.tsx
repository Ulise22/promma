        ...
        <main>
            ...
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Khamzat Chimaev sostiene un récord perfecto de 13-0. Siendo 6 de estas victorias por nocaut, 5 por sumisión y 2 por decisión. Además, 7 de sus victorias fueron en <Link href='/articulos/ufc'>UFC</Link>, 4 en Brave CF, que es una promotora de Medio Oriente, y sus otras 2 peleas se organizaron en Suecia por promotoras menos conocidas.</p>
