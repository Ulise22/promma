...
import pimblett from '@/assets/peleadores__images/0-100/20-30/paddy-pimblett/paddy-pimblett.png'
...
export default function Pimblett () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={pimblett} w={24} l={4} d={0} nombre='Paddy Pimblett' categoria='Peso Ligero' apodo='THE BADDY' time='2026-07-12' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Paddy Pimblett posee un récord profesional de 24-4. Siendo 7 de sus victorias por la vía del nocaut, 11 por la vía de la sumisión y 6 por decisión. Mientras que de sus 4 derrotas, 1 fue por sumisión y 3 fueron por decisión.</p>
