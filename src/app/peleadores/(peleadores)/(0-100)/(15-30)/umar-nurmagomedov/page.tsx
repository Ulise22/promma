...
export default function UmarNurmagomedov () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={20} l={2} d={0} nombre='Umar Nurmagomedov' apodo={null} categoria='Peso Gallo' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Umar Nurmagomedov tiene un récord profesional en las MMA de 20-2. Siendo 2 de sus vcitorias por la vía del nocaut, 7 por la vía de la sumisión y 11 por decisión. Mientras que de sus 2 derrotas, 1 fue por la vía del nocaut y 1 por la vía de la decisión.</p>
