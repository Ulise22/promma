...
export default function RaulRosasJR () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={raul} w={12} l={1} d={0} nombre='Raúl Rosas Jr.' categoria='Peso Gallo' apodo='EL NIÑO PROBLEMA' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Raúl Rosas Jr. posee un récord de 12-1 en su carrera de MMA. Siendo 2 de sus victorias por la vía del nocaut, 6 por la vía de la sumisión y sólo 4 por decisión. Mientras que su única derrota fue por decisión.</p>
