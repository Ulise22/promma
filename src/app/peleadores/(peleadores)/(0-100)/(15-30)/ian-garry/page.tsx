...
export default function IanGarry () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={15} l={1} d={0} nombre='Ian Machado Garry' apodo='THE FUTURE' categoria='Peso Wélter' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ian Machado Garry tiene un récord profesional en las MMA de 15-1. Siendo 7 de sus victorias por la vía del nocaut, sólo 1 de sus victorias fue por sumisión y siendo 7 de sus victorias fueron por decisión. Mientras la que es por el momento, su única derrota, sería por decisión. </p>
