...
export default function IanGarry () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={17} l={2} d={0} nombre='Ian Machado Garry' apodo='THE FUTURE' categoria='Peso Wélter' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ian Machado Garry tiene un récord profesional en las MMA de 17-2. Siendo 7 de sus victorias por la vía del nocaut, sólo 1 de sus victorias fue por sumisión y siendo 9 de sus victorias por decisión. Mientras que sus 2 derrotas fueron por decisión.</p>
