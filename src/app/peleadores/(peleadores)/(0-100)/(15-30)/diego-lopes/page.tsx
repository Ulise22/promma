...
export default function DiegoLopes () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={28} l={8} d={0} nombre='Diego Lopes' apodo={null} categoria='Peso Pluma' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Diego Lopes mantiene un récord profesional de 28-7. Siendo 12 de sus victorias por la vía del nocaut, 12 por la vía de la sumisión y 4 por decisión. Mientras que de sus 8 derrotas, 2 fueron por la vía del nocaut y 6 por decisión.</p>
