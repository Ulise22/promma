...
export default function SharaMagomedov () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={16} l={1} d={0} nombre='Shara Magomedov' apodo='BULLET' categoria='Peso Medio' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Shara Magomedov tiene un récord profesional de 16-1 en lo que lleva de su carrera en las MMA. Siendo 12 de sus victorias por la vía del nocaut y sólo 4 por decisión. Mientras que hasta ahora su única derrota ha sido por la vía de la decisión.</p>
