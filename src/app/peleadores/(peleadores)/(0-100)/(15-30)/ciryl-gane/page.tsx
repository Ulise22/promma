...
import fighter from '@/assets/peleadores__images/0-100/30-40/ciryl-gane/ciryl_gane.png'
...
export default function CirylGane () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={13} l={2} d={0} nombre='Ciryl Gane' apodo='BON GAMIN' categoria='Peso Pesado' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>En una entrevista con la UFC, reconoció que a pesar de no tener héroes como tales, sí que admira y disfruta el estilo de pelea de <Link href='/peleadores/israel-adesanya'>Israel Adesanya</Link>, de <Link href='/leyendas/anderson-silva'>Anderson Silva</Link> y de <Link href='/peleadores/jon-jones'>Jon Jones</Link></p>
                    <h2 className={styles.peleador__article__title}>Ciryl Gane Récord</h2>
                    <p className={styles.peleador__article__text}>Ciryl Gane posee un récord de 13-2 (1) en su carrera de MMA. Siendo 6 de sus victorias por la vía del nocaut, 3 por la vía de la sumisión y 4 por decisión. Mientras que de sus 2 derrotas, sólo 1 fue por sumisión y 1 fue por decisión. Además, su pelea por el cinturón de peso pesado ante el campeón <Link href='/peleadores/tom-aspinall'>Tom Aspinall</Link> quedó sin resultado debido a un piquete ilegal de ojo en el primer asalto que impidió a su rival inglés continuar con el combate.</p>
                    <iframe className={styles.peleador__article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/Id8G_VaN88o?si=qUsJwZrr0cBfnAKR" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/Eu5JkCnHqcY?si=koVb_JKBYFf9tHRE" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/SEKBbBGfuGQ?si=sPuh2MUldGhbslX8" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                    ...
                    <iframe className={styles.peleador__article__video} loading='lazy' width="560" height="315" src="https://www.youtube.com/embed/yreLKev3gcs?si=IyA0BrC49jvsZ4Kp" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
