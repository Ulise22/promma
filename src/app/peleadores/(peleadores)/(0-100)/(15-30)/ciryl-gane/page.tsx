...
export default function CirylGane () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={13} l={2} d={0} nombre='Ciryl Gane' apodo='BON GAMIN' categoria='Peso Pesado' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ciryl Gane posee un récord de 13-2 en su carrera de MMA. Siendo 6 de sus victorias por la vía del nocaut, 3 por la vía de la sumisión y 4 por decisión. Mientras que de sus 2 derrotas, sólo 1 fue por sumisión y 1 fue por decisión.</p>
