...
export default function CirylGane () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={14} l={2} d={0} nombre='Ciryl Gane' apodo='BON GAMIN' categoria='Peso Pesado' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Ciryl Gane posee un récord de 14-2 (1) en su carrera de MMA. Siendo 7 de sus victorias por la vía del nocaut, 3 por la vía de la sumisión y 4 por decisión. Mientras que de sus 2 derrotas, sólo 1 fue por sumisión y 1 fue por decisión. Además, su pelea por el cinturón de peso pesado ante el campeón <Link href='/peleadores/tom-aspinall'>Tom Aspinall</Link> quedó sin resultado debido a un piquete ilegal de ojo en el primer asalto que impidió a su rival inglés continuar con el combate.</p>
