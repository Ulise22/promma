...
export default function JoelAlvarez () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={23} l={4} d={0} nombre='Joel Álvarez' apodo='EL FENÓMENO' categoria='Peso Ligero' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Joel Álvarez mantiene un récord profesional de 23-4. Siendo 6 de sus victorias por la vía del nocaut, 16 por la vía de la sumisión y sólo 1 por decisión. Mientras que de sus 4 derrotas, 2 fueron por la vía del nocaut, 1 por sumisión y sólo 1 fue por decisión.</p>
