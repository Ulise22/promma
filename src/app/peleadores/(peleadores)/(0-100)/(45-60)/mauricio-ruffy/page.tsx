...
export default function PauloCosta () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={14} l={3} d={0} categoria='Peso Ligero' nombre='Mauricio Ruffy' apodo={null} time='2026-09-23' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Mauricio Ruffy posee un récord profesional en MMA de 14-3. Con 13 de sus victorias viniendo por la vía del nocaut y sólo 1 siendo por decisión. Mientras que de sus 3 derrotas 2 fueron por la vía del nocaut y la otra por la vía de la sumisión. </p>
