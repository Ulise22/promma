...
export default function BenoitSaintDenis () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={17} l={4} d={0} categoria='Peso Ligero' nombre='Benoit Saint Denis' apodo='GOD OF WAR' time='2026-07-12' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Benoit Saint Denis posee un récord profesional en MMA de 17-4 (1). Con 6 de sus victorias proviniendo por la vía del nocaut y 11 siendo por la vía de la sumisión. Mientras que de sus 3 derrotas, 2 fueron por la vía del nocaut, 1 por la vía de la sumisión y sólo 1 fue por decisión. Además posee una pelea sin resultado ante el polaco <b>Pawel Kielek</b> en 2019. </p>
