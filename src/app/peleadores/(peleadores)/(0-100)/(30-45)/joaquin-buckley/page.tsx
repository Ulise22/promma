...
export default function JoaquinBuckley () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={21} l={8} d={0} categoria='Peso Wélter' nombre='Joaquin Buckley' apodo='NEW MANSA' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Joaquin Buckley posee un récord profesional de MMA de 21-8. Con 15 de sus victorias siendo por la vía del nocaut, y sólo 6 siendo por la vía de la decisión. Mientras que de sus 8 derrotas, 4 fueron por la vía del nocaut, y 4 por la vía de la decisión. </p>
