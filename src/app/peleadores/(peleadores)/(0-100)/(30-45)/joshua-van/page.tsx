...
export default function JoshuaVan () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={18} l={2} d={0} categoria='Peso Mosca' nombre='Joshua Van' apodo={null} time='2026-09-23' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Joshua Van posee un récord profesional en MMA de 18-2, con 9 de sus victorias proviniendo por la vía del nocaut, con 2 siendo por sumisión y con 7 siendo por decisión. Mientras que de sus 2 derrotas, 1 fue por la vía del nocaut y sólo 1 por la vía de la sumisión. </p>
