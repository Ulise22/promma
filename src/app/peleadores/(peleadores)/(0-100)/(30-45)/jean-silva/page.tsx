...
export default function JeanSilva () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={16} l={3} d={0} categoria='Peso Pluma' nombre='Jean Silva' apodo={null} time='2026-01-22' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Jean Silva posee un récord profesional de 16-3. Con 12 de sus victorias proviniendo por la vía del nocaut, 3 por la vía de la sumisión y sólo 1 llegando a decisión. Mientras que de sus 3 derrotas, sólo 1 fue por la vía del nocaut y las otras 2 fueron por decisión.</p>
