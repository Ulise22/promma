...
export default function WaldoCortesAcosta () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={17} l={4} d={0} categoria='Peso Pesado' nombre='Waldo Cortes Acosta' apodo={null} time='2026-09-13' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Waldo Cortés Acosta posee un récord profesional en las MMA de 17-4. Con 9 de sus victorias siendo por la vía del nocaut, con sólo 1 siendo por sumisión y con 7 victorias siendo por la vía de la decisión. Mientras que sus 4 derrotas fueron por decisión. </p>
