...
export default function Ribovics () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={15} l={3} d={0} nombre='Esteban Ribovics' apodo='EL GRINGO' categoria='Peso Ligero' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Esteban Ribovics posee un récord profesional de 15-2. Siendo 7 de sus victorias por la vía del nocaut, 5 por la vía de la sumisión y sólo 3 por decisión. Mientras que de sus 3 derrotas, 1 fue por la vía de la sumisión y 2 por decisión.</p>
