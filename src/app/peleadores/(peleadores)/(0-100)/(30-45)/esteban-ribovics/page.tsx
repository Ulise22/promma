...
export default function Ribovics () {
    return(
        <main>
            <PeleadoresHero peleadoresImage={fighter} w={15} l={2} d={0} nombre='Esteban Ribovics' apodo='EL GRINGO' categoria='Peso Ligero' time='2025-10-29' />
            <section className={styles.peleador__articles__container}>
                <article className={styles.peleador__article}>
                    ...
                    <p className={styles.peleador__article__text}>Esteban Ribovics posee un récord profesional de 15-2. Siendo 7 de sus victorias por la vía del nocaut, 5 por la vía de la sumisión y sólo 3 por decisión. Mientras que sus 2 únicas derrotas profesionales fue por decisión de los jueces.</p>
